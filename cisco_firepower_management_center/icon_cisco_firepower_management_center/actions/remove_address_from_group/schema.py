...
class Component:
    DESCRIPTION = "Removes an address object from a group"
...
class RemoveAddressFromGroupInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    "address": {
      "type": "string",
      "title": "Address",
      "description": "The hostname, an IP address or subnet address expressed in CIDR notation to remove from group",
      "order": 1
    },
    "group": {
      "type": "string",
...
class RemoveAddressFromGroupOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
