...
func (i *Uuidv4Input) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *Uuidv4Output) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *Uuidv4Action) Run(conn *connection.Connection, input *Uuidv4Input, log plog.Logger) (*Uuidv4Output, error) {
	output := &Uuidv4Output{}
	output.UUID = uuid.NewV4().String()
...
func (a *Uuidv4Action) Test(conn *connection.Connection, input *Uuidv4Input, log plog.Logger) (*Uuidv4Output, error) {
	output := &Uuidv4Output{}
	// Your code here
