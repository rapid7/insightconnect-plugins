...
from icon_azure_ad_admin.actions.enable_user_account import EnableUserAccount
import json
import logging


class TestEnableUserAccount(TestCase):
    def test_integration_enable_user_account(self):
        """
        ...
        test_action = EnableUserAccount()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/enable_user_account.json") as file:
