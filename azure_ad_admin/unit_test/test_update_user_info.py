...
from icon_azure_ad_admin.actions.update_user_info import UpdateUserInfo
import json
import logging


class TestUpdateUserInfo(TestCase):
    def test_integration_update_user_info(self):
        """
        ...
        test_action = UpdateUserInfo()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/update_user_info.json") as file:
