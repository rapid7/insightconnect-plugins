...
class TestGetGroupByName(TestCase):
    def test_get_group_by_name(self):
        ...
        expected = {
            "group": {
                "id": "d2cc6aa2-8071-44d9-a97a-0a758da420a8",
                "createdDateTime": "2018-07-13T17:46:51Z",
                "creationOptions": ["Team", "ExchangeProvisioningFlags:3552"],
                "description": "Komand test for plugin",
                ...
                "proxyAddresses": [
                    "SPO:SPO_5f0de1c4-0f19-4eab-9ede-00c06c2dab4b@SPO_5c824599-dc8c-4d31-96fb-3b886d4f8f10",
                    "SMTP:user@example.com",
                ],
                "renewedDateTime": "2018-07-13T17:46:51Z",
