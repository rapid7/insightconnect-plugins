...
from icon_azure_ad_admin.actions.disable_user_account import DisableUserAccount
import json
import logging


class TestDisableUserAccount(TestCase):
    def test_integration_disable_user_account(self):
        """
        ...
        test_action = DisableUserAccount()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/disable_user_account.json") as file:
