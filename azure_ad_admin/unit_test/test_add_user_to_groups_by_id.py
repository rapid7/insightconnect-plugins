...
from icon_azure_ad_admin.actions.add_user_to_groups_by_id import AddUserToGroupsById
import json
import logging


class TestAddUserToGroupsById(TestCase):
    def test_integration_add_user_to_groups_by_id(self):
        """
        ...
        test_action = AddUserToGroupsById()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/add_user_to_groups_by_id.json") as file:
