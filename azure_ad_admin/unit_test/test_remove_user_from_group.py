...
from icon_azure_ad_admin.actions.remove_user_from_group import RemoveUserFromGroup
import json
import logging


class TestRemoveUserFromGroup(TestCase):
    def test_integration_remove_user_from_group(self):
        """
        ...
        test_action = RemoveUserFromGroup()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/remove_user_from_group.json") as file:
