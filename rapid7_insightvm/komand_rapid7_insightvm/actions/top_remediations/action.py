...
class TopRemediations(komand.Action):
    ...
    def remediations_query(limit):
        return f"SELECT fr.solution_id, fr.assets, fr.vulnerabilities, fr.riskscore, ds.nexpose_id, " \
    ...
    def assets_query(limit):
        return f"WITH criticality_tags AS ( " \
    ...
    def vulnerabilities_query(limit):
        return f"WITH remediation_vulnerabilities AS ( " \
