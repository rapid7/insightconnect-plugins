...
class String(komand.Action):
    ...
    def run(self, params={}):
        md5 = hashlib.md5(params['string'].encode('utf-8')).hexdigest()  # nosec
        sha1 = hashlib.sha1(params['string'].encode('utf-8')).hexdigest()  # nosec
    ...
    def test(self, params={}):
        ...
        test_hashes = {}
        test_hashes['md5'] = hashlib.md5(a).hexdigest()  # nosec
        test_hashes['sha1'] = hashlib.sha1(a).hexdigest()  # nosec
