...
from komand_sentinelone.actions.agents_connect import AgentsConnect
import json
import logging


class TestAgentsConnect(TestCase):
    def test_integration_agents_connect(self):
        """
        ...
        test_action = AgentsConnect()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_connect.json") as file:
