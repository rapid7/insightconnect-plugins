...
from komand_sentinelone.actions.agents_uninstall import AgentsUninstall
import json
import logging


class TestAgentsUninstall(TestCase):
    def test_integration_agents_uninstall(self):
        """
        ...
        test_action = AgentsUninstall()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_uninstall.json") as file:
    ...
    def test_agents_uninstall(self):
        """
