...
from komand_sentinelone.actions.agents_disconnect import AgentsDisconnect
import json
import logging


class TestAgentsDisconnect(TestCase):
    def test_integration_agents_disconnect(self):
        """
        ...
        test_action = AgentsDisconnect()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_disconnect.json") as file:
    ...
    def test_agents_disconnect(self):
        """
