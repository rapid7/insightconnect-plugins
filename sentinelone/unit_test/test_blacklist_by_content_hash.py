...
class TestBlacklistByContentHash(TestCase):
    def test_integration_blacklist_by_content_hash(self):
        """
        ...
        test_action = BlacklistByContentHash()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/blacklist_by_content_hash.json") as file:
    ...
    def test_blacklist_by_content_hash(self):
        """
