...
from komand_sentinelone.actions.agents_fetch_logs import AgentsFetchLogs
import json
import logging


class TestAgentsFetchLogs(TestCase):
    def test_integration_agents_fetch_logs(self):
        """
        ...
        test_action = AgentsFetchLogs()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_fetch_logs.json") as file:
    ...
    def test_agents_fetch_logs(self):
        """
