...
from komand_sentinelone.actions.agents_shutdown import AgentsShutdown
import json
import logging


class TestAgentsShutdown(TestCase):
    def test_integration_agents_shutdown(self):
        """
        ...
        test_action = AgentsShutdown()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_shutdown.json") as file:
