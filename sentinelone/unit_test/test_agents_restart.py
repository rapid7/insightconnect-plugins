...
from komand_sentinelone.actions.agents_restart import AgentsRestart
import json
import logging


class TestAgentsRestart(TestCase):
    def test_integration_agents_restart(self):
        """
        ...
        test_action = AgentsRestart()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_restart.json") as file:
