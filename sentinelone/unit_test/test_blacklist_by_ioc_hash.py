...
from komand_sentinelone.actions.blacklist_by_ioc_hash import BlacklistByIocHash
import json
import logging


class TestBlacklistByIocHash(TestCase):
    def test_integration_blacklist_by_ioc_hash(self):
        """
        ...
        test_action = BlacklistByIocHash()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/blacklist_by_ioc_hash.json") as file:
        ...
        # TODO: Remove blacklist_by_ioc_hash action with next major version bump
