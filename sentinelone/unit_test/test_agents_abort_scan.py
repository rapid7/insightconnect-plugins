...
from komand_sentinelone.actions.agents_abort_scan import AgentsAbortScan
import json
import logging


class TestAgentsAbortScan(TestCase):
    def test_integration_agents_abort_scan(self):
        """
        ...
        test_action = AgentsAbortScan()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_abort_scan.json") as file:
    ...
    def test_agents_abort_scan(self):
        """
