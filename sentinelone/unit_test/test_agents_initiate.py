...
from komand_sentinelone.actions.agents_initiate import AgentsInitiate
import json
import logging


class TestAgentsInitiate(TestCase):
    def test_integration_agents_initiate(self):
        """
        ...
        test_action = AgentsInitiate()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/agents_initiate.json") as file:
