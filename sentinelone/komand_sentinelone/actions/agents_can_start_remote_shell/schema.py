...
class Component:
    DESCRIPTION = "Check if user can start remote shell for the selected agent"
...
class AgentsCanStartRemoteShellInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class AgentsCanStartRemoteShellOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
