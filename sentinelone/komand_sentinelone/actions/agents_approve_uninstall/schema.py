...
class Component:
    DESCRIPTION = "Approve uninstall requests for all agents matching the input filter"
...
class AgentsApproveUninstallInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class AgentsApproveUninstallOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
