...
|url|string|None|True|URL of the Apex Security Manager. Port can be specified as well e.g. https://example.com:443|None|https://example.manage.trendmicro.com|
