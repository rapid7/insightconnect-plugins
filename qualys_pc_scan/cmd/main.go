...
import (
	...
	"github.com/rapid7/komand-plugins/qualys_pc_scan/server/http"
...
var (
	...
	Description = "Qualys plugin for managing policy compliance scans"
...
func main() {
	...
	case httpServer.FullCommand():
		...
		fmt.Printf("Plugin qualys_pc_scan booting HTTP Daemon on port %d...", *port)
