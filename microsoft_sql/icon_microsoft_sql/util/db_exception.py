...
def handle_exceptions(e: pyodbc.Error, query: str):
    ...
    cause = {
        pyodbc.OperationalError: "An operational error occurred. This can be related to the database's operation"
    ...
    raise PluginException(cause=cause[type(e)], assistance=_ASSISTANCE, data=_DATA)
