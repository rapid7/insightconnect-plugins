...
# Apache 2.0
# Original Author: https://github.com/rveachkc
...
class connectorcard:
    ...
    def send(self):
        ...
        if r.status_code == requests.codes.ok:
            ...
            raise PluginException(cause="Microsoft Teams: Send failed.",
                                  assistance=f"Please check your webhook in connection settings. Webhook:\n"
                                             f"{self.hookurl}\n",
                                  data=r.text)
