...
[Google Cloud PubSub](https://cloud.google.com/pubsub/) is a fully-managed real-time messaging service that allows you to send and receive messages. With the InsightConnect plugin automate sending and receiving messages. Trigger of of receiving new messages and take action with the message content
