...
class Connection(insightconnect_plugin_runtime.Connection):
    ...
    def connect(self, parameters):
        ...
        try:
            ...
            root_certificates_decoded = base64.b64decode(
                self.parameters["ca_certificate"]["secretKey"]
            )
            private_key_decoded = base64.b64decode(
                self.parameters["client_private_key"]["secretKey"]
            )
            certificate_chain_decoded = base64.b64decode(
                self.parameters["client_cert"]["secretKey"]
            )
            ...
            self.root_certificates_decoded = base64.b64decode(
                self.parameters["ca_certificate"]["secretKey"]
            )
            self.private_key_decoded = base64.b64decode(
                self.parameters["client_private_key"]["secretKey"]
            )
            self.certificate_chain_decoded = base64.b64decode(
                self.parameters["client_cert"]["secretKey"]
            )
