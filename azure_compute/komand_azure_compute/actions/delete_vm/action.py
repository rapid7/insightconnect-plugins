import komand
from .schema import DeleteVmInput, DeleteVmOutput
...
class DeleteVm(komand.Action):
    ...
    def run(self, params={}):
        try:
            ...
            url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s?api-version=%s'%(subscriptionId, resourceGroup, vm, apiVersion)
