import komand
from .schema import RestartVmInput, RestartVmOutput
...
class RestartVm(komand.Action):
    ...
    def run(self, params={}):
        try:
          ...
          url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s/restart?api-version=%s'%(subscriptionId, resourceGroup, vm, apiVersion)
