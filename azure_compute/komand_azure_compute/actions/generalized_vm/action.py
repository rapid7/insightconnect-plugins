import komand
from .schema import GeneralizedVmInput, GeneralizedVmOutput
...
class GeneralizedVm(komand.Action):
    ...
    def run(self, params={}):
        try:
          ...
          url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s/generalize?api-version=%s'%(subscriptionId, resourceGroup, vm, apiVersion)
