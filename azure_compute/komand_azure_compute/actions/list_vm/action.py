import komand
from .schema import ListVmInput, ListVmOutput
...
class ListVm(komand.Action):
    ...
    def run(self, params={}):
        try:
          ...
          url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualmachines?api-version=%s'%(subscriptionId, resourceGroup, apiVersion)
