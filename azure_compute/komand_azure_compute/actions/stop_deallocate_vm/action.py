import komand
from .schema import StopDeallocateVmInput, StopDeallocateVmOutput
...
class StopDeallocateVm(komand.Action):
    ...
    def run(self, params={}):
        try:
          ...
          url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s/deallocate?api-version=%s'%(subscriptionId, resourceGroup, vm, apiVersion)
