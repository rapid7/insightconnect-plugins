import komand
from .schema import SizesVmInput, SizesVmOutput
...
class SizesVm(komand.Action):
    ...
    def run(self, params={}):
        try:
          ...
          url = server + '/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s/vmSizes?api-version=%s'%(subscriptionId, resourceGroup, vm, apiVersion)
