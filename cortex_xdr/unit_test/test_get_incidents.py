...
from icon_cortex_xdr.triggers.get_incidents import GetIncidents
import logging
import json
...
class TestGetIncidents(TestCase):
    ...
    def test_integration_get_incidents(self, mockSend):
        """
        ...
        try:
            with open("../tests/get_incidents.json") as f:
                data = json.load(f)
        ...
        test_email_received = GetIncidents()
    ...
    def test_get_incidents_some_function_to_test(self):
        """
