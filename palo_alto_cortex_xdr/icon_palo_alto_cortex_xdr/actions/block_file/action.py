...
class BlockFile(insightconnect_plugin_runtime.Action):
    def __init__(self):
        super(self.__class__, self).__init__(
            name="block_file", description=Component.DESCRIPTION, input=BlockFileInput(), output=BlockFileOutput()
        )
    ...
    def run(self, params={}):
        ...
        return {Output.SUCCESS: self.connection.xdr_api.allow_or_block_file(file_hash, comment, incident_id, True)}
