...
class Search(komand.Action):
    def __init__(self):
        super(self.__class__, self).__init__(
            name="search", description="Search all data", input=SearchInput(), output=SearchOutput()
        )
    ...
    def run(self, params={}):
        ...
        try:
            ...
            try:
                search_results = requests.get(search_url, headers=search_headers, params=search_params, verify=False)   # noqa: B501
