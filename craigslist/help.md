...
|has_image|boolean|False|False|Posting contains an image|None|False|
|posted_today|boolean|False|False|Was posted today|None|False|
|query|string|None|False|Query string|None|amp|
|search_distance|integer|None|False|Search distance in miles|None|20|
|search_titles|boolean|False|False|Search the titles|None|True|
|section_filter|object|None|False|Craigslist has specific filters for each category. You can fine tune your search by entering a section specific filter as JSON e.g. { "max_price": 5000, "auto_size": "compact", "auto_paint": "blue" }|None|{"condition": "like new","max_price": 1000}|
...
|zip_code|integer|None|False|Zipcode|None|61736|
