...
class CreateUserpolicyInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
    ...
    "userpolicy": {
      ...
      "properties": {
        ...
        "Schedule": {
          "type": "string",
          "title": "Schedule",
          "description": "Schedule time that is available eg. All The Time, Work Hours[5 Day Week]",
...
class CreateUserpolicyOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
