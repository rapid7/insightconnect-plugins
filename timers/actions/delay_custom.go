...
func (i *DelayInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *DelayOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *DelayAction) Run(conn *connection.Connection, input *DelayInput, log plog.Logger) (*DelayOutput, error) {
	output := &DelayOutput{}
...
func (a *DelayAction) Test(conn *connection.Connection, input *DelayInput, log plog.Logger) (*DelayOutput, error) {
	output := &DelayOutput{}
	// Your code here
