...
// CustomPeriodicTriggerInputParams defines any bonus params needed for the trigger run
type CustomPeriodicTriggerInputParams struct {
...
func (i *PeriodicTriggerInput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (o *PeriodicTriggerOutput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (t *PeriodicTrigger) Run(conn *connection.Connection, input *PeriodicTriggerInput, log plog.Logger) (*PeriodicTriggerOutput, error) {
	output := &PeriodicTriggerOutput{}

	duration := time.Duration(input.Period * float64(time.Minute))
...
func (t *PeriodicTrigger) Test(conn *connection.Connection, input *PeriodicTriggerInput, log plog.Logger) (*PeriodicTriggerOutput, error) {
	output := &PeriodicTriggerOutput{}
	// Your code here
