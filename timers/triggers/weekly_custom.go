...
// CustomWeeklyTriggerInputParams defines any bonus params needed for the trigger run
type CustomWeeklyTriggerInputParams struct {
...
func (i *WeeklyTriggerInput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (o *WeeklyTriggerOutput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (t *WeeklyTrigger) Run(conn *connection.Connection, input *WeeklyTriggerInput, log plog.Logger) (*WeeklyTriggerOutput, error) {
	output := &WeeklyTriggerOutput{}
	times, err := parseDailyTimes(input.TimesInUtc)
	weekday := weekdayMap[input.Day]
	if err != nil {
		return nil, err
	}
...
func (t *WeeklyTrigger) Test(conn *connection.Connection, input *WeeklyTriggerInput, log plog.Logger) (*WeeklyTriggerOutput, error) {
	output := &WeeklyTriggerOutput{}
	// Your code here
