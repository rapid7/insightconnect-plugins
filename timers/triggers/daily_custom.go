...
// CustomDailyTriggerInputParams defines any bonus params needed for the trigger run
type CustomDailyTriggerInputParams struct {
...
func (i *DailyTriggerInput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (o *DailyTriggerOutput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (t *DailyTrigger) Run(conn *connection.Connection, input *DailyTriggerInput, log plog.Logger) (*DailyTriggerOutput, error) {
	output := &DailyTriggerOutput{}
...
func (t *DailyTrigger) Test(conn *connection.Connection, input *DailyTriggerInput, log plog.Logger) (*DailyTriggerOutput, error) {
	output := &DailyTriggerOutput{}
	// Your code here
