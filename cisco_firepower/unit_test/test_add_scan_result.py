...
from komand_cisco_firepower.actions.add_scan_result import AddScanResult
import json
import logging


class TestAddScanResult(TestCase):
    def test_integration_add_scan_result(self):
        """
        ...
        test_action = AddScanResult()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/add_scan_result.json") as file:
