...
from komand_cisco_firepower.connection.connection import Connection
from komand_cisco_firepower.actions.bulk_add_scan_result import BulkAddScanResult
import json
import logging


class TestBulkAddScanResult(TestCase):
    def test_integration_bulk_add_scan_result(self):
        """
        ...
        test_action = BulkAddScanResult()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/bulk_add_scan_result.json") as file:
    ...
    def test_bulk_add_scan_result(self):
        """
