import komand
from .schema import SearchForMacAddressUsagesInput, SearchForMacAddressUsagesOutput
...
class SearchForMacAddressUsages(komand.Action):
    ...
    def run(self, params={}):
        ...
        results = self.connection.api.search_for_mac_address_usages(mac_address, max_results)
