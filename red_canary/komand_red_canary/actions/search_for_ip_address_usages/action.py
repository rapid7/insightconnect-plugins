import komand
from .schema import SearchForIpAddressUsagesInput, SearchForIpAddressUsagesOutput
...
class SearchForIpAddressUsages(komand.Action):
    ...
    def run(self, params={}):
        ...
        results = self.connection.api.search_for_ip_address_usages(ip_address, max_results)
