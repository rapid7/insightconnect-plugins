import komand
from .schema import DeactivateActivityMonitorInput, DeactivateActivityMonitorOutput
...
class DeactivateActivityMonitor(komand.Action):
    ...
    def run(self, params={}):
        ...
        activity_monitor = self.connection.api.deactivate_activity_monitor(activity_monitor_id)
