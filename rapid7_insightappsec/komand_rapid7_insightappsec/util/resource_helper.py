...
class ResourceHelper(object):
    ...
    def resource_request(self, endpoint: str, method: str = 'get', params: dict = None,
        ...
        if response.status_code in range(200, 299):
            ...
            raise PluginException(cause=f'Insight AppSec returned a status code of {response.status_code}',
                                  assistance=f'{status_code_message}\n',
                                  data=f'Response Body:{response.text}')
