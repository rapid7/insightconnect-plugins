import komand
from .schema import QueryInput, QueryOutput, Input, Output  # Custom imports below
...
class Query(komand.Action):
    ...
    def run(self, params={}):
        ...
        conn.search(search_base=params.get("search_base"), search_filter=escaped_query, attributes=attributes)
