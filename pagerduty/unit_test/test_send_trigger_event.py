...
class TestSendTriggerEvent(TestCase):
    def test_integration_send_trigger_event(self):
        """
        ...
        test_action = SendTriggerEvent()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/send_trigger_event.json") as file:
    ...
    def test_send_trigger_event(self):
        """
