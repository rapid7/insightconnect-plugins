...
class TestSendResolveEvent(TestCase):
    def test_integration_send_resolve_event(self):
        """
        ...
        test_action = SendResolveEvent()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/send_resolve_event.json") as file:
    ...
    def test_send_resolve_event(self):
        """
