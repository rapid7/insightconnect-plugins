...
class TestSendAcknowledgeEvent(TestCase):
    def test_integration_send_acknowledge_event(self):
        """
        ...
        test_action = SendAcknowledgeEvent()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/send_acknowledge_event.json") as file:
    ...
    def test_send_acknowledge_event(self):
        """
