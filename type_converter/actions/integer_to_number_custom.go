...
func (i *IntegerToNumberInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *IntegerToNumberOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *IntegerToNumberAction) Run(conn *connection.Connection, input *IntegerToNumberInput, log plog.Logger) (*IntegerToNumberOutput, error) {
	output := &IntegerToNumberOutput{}
	output.Output = float64(input.Input)
	return output, nil
}
...
func (a *IntegerToNumberAction) Test(conn *connection.Connection, input *IntegerToNumberInput, log plog.Logger) (*IntegerToNumberOutput, error) {
