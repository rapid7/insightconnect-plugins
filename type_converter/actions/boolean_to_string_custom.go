...
func (i *BooleanToStringInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *BooleanToStringOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *BooleanToStringAction) Run(conn *connection.Connection, input *BooleanToStringInput, log plog.Logger) (*BooleanToStringOutput, error) {
...
func (a *BooleanToStringAction) Test(conn *connection.Connection, input *BooleanToStringInput, log plog.Logger) (*BooleanToStringOutput, error) {
