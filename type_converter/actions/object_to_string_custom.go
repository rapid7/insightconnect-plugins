...
func (i *ObjectToStringInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *ObjectToStringOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *ObjectToStringAction) Run(conn *connection.Connection, input *ObjectToStringInput, log plog.Logger) (*ObjectToStringOutput, error) {
	output := &ObjectToStringOutput{}
	bytes, err := json.Marshal(input.Input)
	if err == nil {
		output.Output = string(bytes)
	}
	return output, err
}
...
func (a *ObjectToStringAction) Test(conn *connection.Connection, input *ObjectToStringInput, log plog.Logger) (*ObjectToStringOutput, error) {
