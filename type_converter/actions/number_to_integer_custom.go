...
func (i *NumberToIntegerInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *NumberToIntegerOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *NumberToIntegerAction) Run(conn *connection.Connection, input *NumberToIntegerInput, log plog.Logger) (*NumberToIntegerOutput, error) {
	output := &NumberToIntegerOutput{}
	output.Output = int(input.Input)
	return output, nil
}
...
func (a *NumberToIntegerAction) Test(conn *connection.Connection, input *NumberToIntegerInput, log plog.Logger) (*NumberToIntegerOutput, error) {
