...
func (i *IntegerToBooleanInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *IntegerToBooleanOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *IntegerToBooleanAction) Run(conn *connection.Connection, input *IntegerToBooleanInput, log plog.Logger) (*IntegerToBooleanOutput, error) {
...
func (a *IntegerToBooleanAction) Test(conn *connection.Connection, input *IntegerToBooleanInput, log plog.Logger) (*IntegerToBooleanOutput, error) {
