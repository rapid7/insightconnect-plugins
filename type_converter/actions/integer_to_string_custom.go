...
func (i *IntegerToStringInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *IntegerToStringOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *IntegerToStringAction) Run(conn *connection.Connection, input *IntegerToStringInput, log plog.Logger) (*IntegerToStringOutput, error) {
	output := &IntegerToStringOutput{}
	output.Output = strconv.FormatInt(int64(input.Input), 10)
	return output, nil
}
...
func (a *IntegerToStringAction) Test(conn *connection.Connection, input *IntegerToStringInput, log plog.Logger) (*IntegerToStringOutput, error) {
