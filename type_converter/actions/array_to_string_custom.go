...
func (i *ArrayToStringInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *ArrayToStringOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *ArrayToStringAction) Run(conn *connection.Connection, input *ArrayToStringInput, log plog.Logger) (*ArrayToStringOutput, error) {
	output := &ArrayToStringOutput{}

	if input.Delimiter == "" {
		fmt.Errorf("Delimiter not provided by user. Defaulting to the space character")
		input.Delimiter = " "
	}
	output.Output = strings.Join(input.Input, input.Delimiter)
...
func (a *ArrayToStringAction) Test(conn *connection.Connection, input *ArrayToStringInput, log plog.Logger) (*ArrayToStringOutput, error) {
	output := &ArrayToStringOutput{}
	// Your code here
