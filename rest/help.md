...
* 3.1.0 - Support Digest Auth, Bearer Token, a method to encrypt a secret key in custom headers, and built-in authentication for Insight platform, Pendo and OpsGenie
