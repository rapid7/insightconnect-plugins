...
type Connection struct {
	CustomParams
	ClientExternalIP    string `json:"client_external_ip"`
	ClientMachineName   string `json:"client_machine_name"`
	ExportsFileHostname string `json:"exports_file_hostname"`
	MountPathname       string `json:"mount_pathname"`
