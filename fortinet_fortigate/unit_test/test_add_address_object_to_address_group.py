...
class TestAddAddressObjectToAddressGroup(TestCase):
    def test_integration_add_address_object_to_address_group(self):
        """
        ...
        test_action = AddAddressObjectToAddressGroup()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/add_address_object_to_address_group.json") as file:
