...
class TestRunAntivirusScan(TestCase):
    def test_integration_run_antivirus_scan(self):
        """
        ...
        test_action = RunAntivirusScan()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/21_run_antivirus_scan_bad_in_progress.json") as file:
    ...
    def test_run_antivirus_scan(self):
        """
