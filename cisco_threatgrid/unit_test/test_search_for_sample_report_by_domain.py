...
class TestSearchForSampleReportByDomain(TestCase):
    def test_integration_search_for_sample_report_by_domain(self):
        log = logging.getLogger("Test")
        test_conn = Connection()
        test_action = SearchForSampleReportByDomain()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/search_for_sample_report_by_domain.json") as file:
