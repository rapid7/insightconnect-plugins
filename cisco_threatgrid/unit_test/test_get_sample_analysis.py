...
from icon_cisco_threatgrid.actions.get_sample_analysis import GetSampleAnalysis
import json
import logging


class TestGetSampleAnalysis(TestCase):
    def test_integration_get_sample_analysis(self):
        """
        ...
        test_action = GetSampleAnalysis()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/get_sample_analysis.json") as file:
