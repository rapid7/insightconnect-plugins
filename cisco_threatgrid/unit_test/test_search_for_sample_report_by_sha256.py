...
from icon_cisco_threatgrid.actions.search_for_sample_report_by_sha256 import SearchForSampleReportBySha256
import json
import logging


class TestSearchForSampleReportBySha256(TestCase):
    def test_integration_search_for_sample_report_by_sha256(self):
        """
        ...
        test_action = SearchForSampleReportBySha256()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/search_for_sample_report_by_sha256.json") as file:
    ...
    def test_search_for_sample_report_by_sha256(self):
        """
