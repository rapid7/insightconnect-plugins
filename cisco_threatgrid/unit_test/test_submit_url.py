...
from icon_cisco_threatgrid.actions.submit_url import SubmitUrl
import json
import logging


class TestSubmitUrl(TestCase):
    def test_integration_submit_url(self):
        """
        ...
        test_action = SubmitUrl()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/submit_url.json") as file:
