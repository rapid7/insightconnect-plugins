...
from icon_cisco_threatgrid.actions.search_for_sample_report_by_id import SearchForSampleReportById
import json
import logging


class TestSearchForSampleReportById(TestCase):
    def test_integration_search_for_sample_report_by_id(self):
        """
        ...
        test_action = SearchForSampleReportById()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/search_for_sample_report_by_id.json") as file:
    ...
    def test_search_for_sample_report_by_id(self):
        """
