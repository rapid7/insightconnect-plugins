...
from icon_cisco_threatgrid.actions.submit_sample import SubmitSample
import json
import logging


class TestSubmitSample(TestCase):
    def test_integration_submit_sample(self):
        """
        ...
        test_action = SubmitSample()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/submit_sample.json") as file:
