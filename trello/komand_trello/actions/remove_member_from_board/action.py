import komand
from .schema import RemoveMemberFromBoardInput, RemoveMemberFromBoardOutput
...
class RemoveMemberFromBoard(komand.Action):

    def __init__(self):
        super(self.__class__, self).__init__(
                name='remove_member_from_board',
                description='Remove member from board',
                input=RemoveMemberFromBoardInput(),
                output=RemoveMemberFromBoardOutput())
