...
func (i *UploadSnippetInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *UploadSnippetOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *UploadSnippetAction) Run(conn *connection.Connection, input *UploadSnippetInput, log plog.Logger) (*UploadSnippetOutput, error) {
	...
	output := &UploadSnippetOutput{File: file}
...
func (a *UploadSnippetAction) Test(conn *connection.Connection, input *UploadSnippetInput, log plog.Logger) (*UploadSnippetOutput, error) {
	output := &UploadSnippetOutput{}
	// Your code here
