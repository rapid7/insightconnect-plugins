...
// CustomMessageTriggerInputParams defines any bonus params needed for the trigger run
type CustomMessageTriggerInputParams struct {
...
func (i *MessageTriggerInput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (o *MessageTriggerOutput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (t *MessageTrigger) Run(conn *connection.Connection, input *MessageTriggerInput, log plog.Logger) (*MessageTriggerOutput, error) {
	output := &MessageTriggerOutput{}
	// Your code here
...
func (t *MessageTrigger) Test(conn *connection.Connection, input *MessageTriggerInput, log plog.Logger) (*MessageTriggerOutput, error) {
	output := &MessageTriggerOutput{}
	// Your code here
	// Use the `log` object passed into the Connect method and any logging information
	// will be returned with the message in the log field. Otherwise, it will be discarded.
