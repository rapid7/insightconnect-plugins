...
// CustomMessageWithFileTriggerInputParams defines any bonus params needed for the trigger run
type CustomMessageWithFileTriggerInputParams struct {
...
func (i *MessageWithFileTriggerInput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (o *MessageWithFileTriggerOutput) Validate(log plog.Logger) []error {
	errors := make([]error, 0)
...
func (t *MessageWithFileTrigger) Run(conn *connection.Connection, input *MessageWithFileTriggerInput, log plog.Logger) (*MessageWithFileTriggerOutput, error) {
	output := &MessageWithFileTriggerOutput{}
	// Your code here
...
func (t *MessageWithFileTrigger) Test(conn *connection.Connection, input *MessageWithFileTriggerInput, log plog.Logger) (*MessageWithFileTriggerOutput, error) {
	output := &MessageWithFileTriggerOutput{}
	// Your code here
	// Use the `log` object passed into the Connect method and any logging information
	// will be returned with the message in the log field. Otherwise, it will be discarded.
