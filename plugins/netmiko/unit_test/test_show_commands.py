...
from komand_netmiko.actions.show_commands import ShowCommands
from komand_netmiko.actions.show_commands.schema import Input


class TestShowCommands(TestCase):
    def setUp(self):
        self.action = ShowCommands()
    ...
    def test_show_commands_success(self, mock_connection):
        mock_connection.client = self.mock_client
        self.mock_client().send_command.return_value = {
