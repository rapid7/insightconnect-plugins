...
class TestListIpAddressesRiskRules(TestCase):
    ...
    @parameterized.expand(
        [
            [
                Util.read_file_to_dict("expected/list_ip_addresses_risk_rules.json.resp"),
            ],
        ]
    )
    def test_list_ip_addresses_risk_rules(self, mock_request: MagicMock, expected: Dict[str, Any]) -> None:
