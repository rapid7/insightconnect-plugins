...
class Component:
    DESCRIPTION = "Polls information about workbench alerts that match the specified criteria in a paginated list**API key role permissions required:****Workbench**- View, filter, and search"
...
class PollAlertListInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
...
class PollAlertListOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
