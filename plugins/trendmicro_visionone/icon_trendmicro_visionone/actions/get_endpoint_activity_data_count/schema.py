...
class Component:
    DESCRIPTION = "Displays count of search results from the Endpoint Activity Data source in a paginated list**API key role permissions required:****Search**- View, filter, and search"
