...
class Component:
    DESCRIPTION = "Gets information about Observed Attack Techniques (OATs) events that match the specified criteria in a list**API key role permissions required:****Observed Attack Techniques**- View, filter, and search"
...
class GetOatListInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
...
class GetOatListOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
