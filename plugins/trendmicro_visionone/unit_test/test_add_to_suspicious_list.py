...
from icon_trendmicro_visionone.actions import AddToSuspiciousList
...
class TestAddToSuspiciousList(TestCase):
    ...
    def test_add_to_suspicious_list_success(self):
    ...
    def test_add_to_suspicious_list_failure(self):
        self.action.connection.client.add_to_suspicious_list = MagicMock(
