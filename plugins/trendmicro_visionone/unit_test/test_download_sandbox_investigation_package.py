...
from icon_trendmicro_visionone.actions.download_sandbox_investigation_package import DownloadSandboxInvestigationPackage
import json
import logging


class TestDownloadSandboxInvestigationPackage(TestCase):
    def test_download_sandbox_investigation_package(self):
        """
