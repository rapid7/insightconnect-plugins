...
class DiskAttachInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    ...
    "source": {
      "type": "string",
      "title": "Source",
      "description": "Valid partial or full URL to an existing persistent disk resource",
      "order": 3
    },
    "zone": {
      "type": "string",
...
class DiskAttachOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
