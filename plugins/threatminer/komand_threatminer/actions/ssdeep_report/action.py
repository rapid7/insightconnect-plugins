import komand
from .schema import SsdeepReportInput, SsdeepReportOutput
...
class SsdeepReport(komand.Action):

    API_URL = "https://www.threatminer.org/ssdeep.php?api=True&rt=2"
    ...
    def test(self):
        params = {"q": "1536:TJsNrChuG2K6IVOTjWko8a9P6W3OEHBQc4w4:TJs0oG2KSTj3o8a9PFeEHn4l"}
