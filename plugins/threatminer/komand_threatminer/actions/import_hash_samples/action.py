import komand
from .schema import ImportHashSamplesInput, ImportHashSamplesOutput
...
class ImportHashSamples(komand.Action):

    API_URL = "https://www.threatminer.org/imphash.php?api=True&rt=1"
    ...
    def test(self):
        params = {"q": "1f4f257947c1b713ca7f9bc25f914039"}
