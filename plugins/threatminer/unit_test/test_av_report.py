...
from icon_threatminer.actions.av_report import AvReport
from icon_threatminer.actions.av_report.schema import Input, Output


class TestAvReport(TestCase):
    def setUp(self) -> None:
        self.action = Util.default_connector(AvReport())
    ...
    def test_av_report_exception(self, mock_request: Callable, cause: str, assistance: str) -> None:
