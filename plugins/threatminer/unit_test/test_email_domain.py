...
from icon_threatminer.actions.email_domain import EmailDomain
from icon_threatminer.actions.email_domain.schema import Input, Output


class TestEmailDomain(TestCase):
    def setUp(self) -> None:
        self.action = Util.default_connector(EmailDomain())
    ...
    def test_email_domain_exception(self, mock_request: Callable, cause: str, assistance: str) -> None:
