...
|----|----|-------|--------|-----------|----|-------|
|admin_user|string|None|True|Admin user to impersonate, e.g. admin@domain.com|None|https://example.com|
|auth_provider_x509_cert_url|string|https://example.com|True|OAUTH2 Auth Provider x509 Cert URL|None|https://example.com|
|auth_uri|string|https://example.com|True|OAUTH2 Auth URI|None|https://example.com|
|client_email|string|None|True|Client email from service credentials|None|https://example.com|
|client_id|string|None|True|Client ID|None|1.0279049573803e+20|
|client_x509_cert_url|string|None|True|x509 cert URL from service credentials|None|https://example.com|
|oauth_scope|string|https://example.com|True|Google Admin Directory OAuth scope to use for the connection, note that read only will result in some actions not working.|['https://www.googleapis.com/auth/admin.directory.user', 'https://www.googleapis.com/auth/admin.directory.user.readonly']|https://example.com|
...
|token_uri|string|https://example.com|True|OAUTH2 Token URI|None|https://example.com|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|email|string|None|True|Email of user|None|https://example.com|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|domain|string|None|True|Domain to retrieve users from|None|https://example.com|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|email|string|None|True|Email of user to suspend|None|https://example.com|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|email|string|None|True|Email of user to unsuspend|None|https://example.com|
