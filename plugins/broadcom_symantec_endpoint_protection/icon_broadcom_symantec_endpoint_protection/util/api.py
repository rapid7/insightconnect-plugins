...
class APIClient(object):
    ...
    def _get_async_session(self) -> aiohttp.ClientSession:
        ...
        return aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=self.ssl_verify), headers=self._get_headers())
    ...
    def new_client(
        ...
        response = requests.post(url=auth_url, json=auth_body, headers=headers, verify=ssl_verify, timeout=60)
