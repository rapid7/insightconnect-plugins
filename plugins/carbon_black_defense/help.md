...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|device_external_ip|string|None|False|Device external ip|None|None|
|device_installed_by|string|None|False|Device installed by|None|None|
|device_name|string|None|False|Device name|None|None|
|enriched_event_type|string|None|False|Enriched event type|None|None|
|process_hash|[]string|None|False|Filter on events generated by a process with the given SHA-256 hash. Note that this hash must be lowercase|None|None|
|process_name|string|None|False|Process name|None|None|
...
* 4.0.0 - Update find event action
