    ...
    "event_info": {
      ...
      "properties": {
        ...
        "device_location": {
          ...
          "description": "The endpoint’s current location relative to the organization’s network, based on the current IP address and the device’s registered DNS domain suffix",
          "order": 51
        },
        "device_name": {
          "type": "string",
