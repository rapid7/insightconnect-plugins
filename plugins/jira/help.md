...
* 6.3.1 - Fix Issue Where Create Issue failed when multiple versions of the input Issue Type exists in Jira | Fix failed connection test response for PAT based connection | Fix Issue where Fields output was not returned in New Issue Trigger and Monitor Issues Trigger
