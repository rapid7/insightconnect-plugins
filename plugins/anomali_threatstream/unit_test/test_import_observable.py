...
class TestImportObservable(TestCase):
    def test_integration_import_observable(self):
        """
        ...
        test_action = ImportObservable()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/import_observable.json") as file:
    ...
    def test_import_observable(self):
        """
