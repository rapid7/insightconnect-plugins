...
class TestGetSandboxReport(TestCase):
    def test_integration_get_sandbox_report(self):
        """
        ...
        test_action = GetSandboxReport()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/get_sandbox_report.json") as file:
    ...
    def test_get_sandbox_report(self):
        """
