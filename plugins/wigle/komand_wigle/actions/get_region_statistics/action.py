...
class GetRegionStatistics(komand.Action):
    ...
    def run(self, params={}):
        ...
        response = self.connection.call_api("get", "stats/regions", params={"country": country})
        return response

    def test(self):
        return {
            "country": "jp",
            "regions": [{"region": "東京都", "count": 5907792}, {"region": "神奈川県", "count": 750393}],
            "encryption": [{"wep": "2", "count": 7160339}, {"wep": "Y", "count": 1941846}],
            "postalCode": [
                {"postalCode": "052-201-4814", "count": 80525},
                {"postalCode": "460-8688", "count": 79119},
            ],
        }
