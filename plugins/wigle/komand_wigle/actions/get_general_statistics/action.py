...
class GetGeneralStatistics(komand.Action):
    ...
    def run(self, params={}):
        self.logger.info("GetGeneralStatistics: Fetching general statistics ...")
    ...
    def test(self):
        return {
            "statistics": {
                ...
                "netwep": 32294041,
                "ssidStatistics": [
                    {"name": "xfinitywifi", "value": 9533081},
                    {"name": "linksys", "value": 3079971},
                ],
                "netwwwd3": 221378,
                "manufacturerStatistics": [
                    {"name": "Cisco Systems, Inc", "value": 28263824},
                    {"name": "Netgear", "value": 27731830},
                ],
                "transtot": 2341560,
                "ieeeManufacturerStatistics": [
                    {"name": "Cisco Systems, Inc", "value": 28454480},
                    {"name": "NETGEAR", "value": 27731830},
                ],
                "dfltnowp": 0,
                "genloc": 9946019,
