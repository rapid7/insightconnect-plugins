...
|client_certificate|file|None|True|Client certificate for mutual TLS (Certificate or Certificate/Key combination)|None|certificate.pem|
|client_key|file|None|True|Private key for mutual TLS (requires Client Certificate)|None|key.pem|
client_
Example input:
