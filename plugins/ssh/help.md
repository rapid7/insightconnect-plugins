...
| :--- | :--- | :--- | :--- | :--- | :--- |
|All Output|string|None|True|All output|None|
|STDERR|string|None|True|Stderr|None|
|STDOUT|string|None|True|Stdout|None|
...
* 4.0.1 - Update from komand to insight-plugin
