...
from .schema import PhoneLookupInput, PhoneLookupOutput, Input, Output, \
    Component
...
class PhoneLookup(insightconnect_plugin_runtime.Action):
    ...
    def run(self, params={}) -> dict:
        ...
        self.logger.info(
            f"[ACTION LOG] Getting information for Phone: {params.get(Input.PHONE)} \n"
        )
        response = self.connection.ipqs_client.ipqs_lookup(
            PHONE_ENDPOINT, additional_params
        )
