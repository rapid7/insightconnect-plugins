...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|admin_user|string|None|True|Admin user to impersonate, e.g. user@example.com|None|user@example.com|None|None|
|auth_provider_x509_cert_url|string|https://www.googleapis.com/oauth2/v1/certs|True|OAUTH2 Auth Provider x509 Cert URL|None|https://www.googleapis.com/oauth2/v1/certs|None|None|
|auth_uri|string|https://accounts.google.com/o/oauth2/auth|True|OAUTH2 Auth URI|None|https://accounts.google.com/o/oauth2/auth|None|None|
|client_email|string|None|True|Client email from service credentials|None|user@example.com|None|None|
|client_id|string|None|True|Client ID|None|102790495738029996994|None|None|
|client_x509_cert_url|string|None|True|X509 cert URL from service credentials|None|https://www.googleapis.com/robot/v1/metadata/x509/user@example.com|None|None|
...
|private_key_id|string|None|True|Private Key ID from service credentials|None|02699626f388ed830012e5b787640e71c56d42d8|None|None|
|project_id|string|None|True|Project ID from service credentials|None|example-12345|None|None|
|token_uri|string|https://accounts.google.com/o/oauth2/token|True|OAUTH2 Token URI|None|https://accounts.google.com/o/oauth2/token|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|file_id|string|None|True|The ID of the file that will be copied to another folder|None|1pAT5CqVKi6XtyaD4betZvDQqOt8ZcuUR|None|None|
|folder_id|string|None|True|ID of the folder where the file will be copied|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
|new_file_name|string|None|False|Select a new file name. e.g. testfile.csv|None|test.txt|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|file|file|None|True|The file to create|None|{'filename': 'test.txt', 'content': 'UmFwaWQ3IEluc2lnaHRDb25uZWN0Cg=='}|None|None|
|folder_id|string|None|True|The ID of the folder where the file will be created|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|folder_name|string|None|True|The name for the new folder|None|New Folder|None|None|
|parent_folder_id|string|None|False|The ID of the folder in which the new folder will be created|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|filename|string|None|True|The name of the file to search for|None|test|None|None|
|filename_operator|string|None|True|How the filename search will be performed. =,!=, or contains|["=", "!=", "contains"]|contains|None|None|
|parent_id|string|None|False|The ID of the parent folder|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|file_id|string|None|True|The file ID for the file that will be returned|None|1sTWaJ_j7PkjzaBWtNc3IzovK5hQf21FbOw9yLeeLPNQ|None|None|
|mime_type|string|None|True|The MIME Type to export the file as e.g. */* , text/plain|None|text/plain|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|file_id|string|None|True|The ID of the file that will be moved to another folder|None|1pAT5CqVKi6XtyaD4betZvDQqOt8ZcuUR|None|None|
|folder_id|string|None|True|ID of the folder where the file will be moved|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|content|bytes|None|True|The new data that will overwrite the old file|None|UmFwaWQ3IEluc2lnaHRDb25uZWN0Cg==|None|None|
|file_id|string|None|True|The file ID for the file that will be overwritten|None|1sTWaJ_j7PkjzaBWtNc3IzovK5hQf21FbOw9yLeeLPNQ|None|None|
|new_file_name|string|None|False|Select a new file name. e.g. testfile.csv|None|test.txt|None|None|
|new_mime_type|string|None|True|Select a new MIME type for the file|["Docs", "Sheets", "Slides"]|Docs|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|file|file|None|True|The file to upload|None|{'filename': 'test.txt', 'content': 'UmFwaWQ3IEluc2lnaHRDb25uZWN0Cg=='}|None|None|
|folder_id|string|None|False|Folder to put the file in|None|0BwwA4oUTeiV1TGRPeTVjaWRDY1E|None|None|
|google_file_type|string|None|True|The file type that Google will convert the file to|["Docs", "Sheets", "Slides"]|Docs|None|None|
...
* 3.0.1 - Updated dependencies | Bump SDK to the latest (6.6.0)
