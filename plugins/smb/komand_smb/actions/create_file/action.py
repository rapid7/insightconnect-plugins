    ...
    def run(self, params={}):
        ...
        if not overwrite_existing:
            try:
                ...
                raise PluginException(cause='Can not overwrite existing file.',
        ...
        try:
            ...
            raise PluginException(cause='Failed to create a file. This may occur when the file does not exist.',
                                  data=e)
        except smb.base.SMBTimeout as e:
            raise PluginException(cause="Timeout reached when connecting to SMB endpoint.",
                                  assistance="Validate network connectivity.",
