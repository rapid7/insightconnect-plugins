...
class TestReport(TestCase):
    ...
    def test_report(self, mocked_request):
        actual = self.action.run({
            Input.HASH: "30f800f97aeaa8d62bdf3a6fb2b0681179a360c12e127f07038f8521461e5050"
        })
        expected = {
            "related_reports": [],
            "state": "SUCCESS"
    ...
    def test_bad_report(self, mocked_request):
        ...
        self.assertEqual("The API only supports SHA256 hashes. Please check the provided hash and try again.", context.exception.assistance)