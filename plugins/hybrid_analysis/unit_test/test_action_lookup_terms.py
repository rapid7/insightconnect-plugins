...
class TestLookUpTerms(TestCase):
    ...
    def test_lookup_terms_similarTo(self, mocked_request):
        actual = self.action.run({
            Input.SIMILAR_TO: "ef537f25c895bfa782526529a9b63d97aa631564d5d789c2b765448c8635fb6c"
        })
        expected = {
            "count": 0,
            "result": [],
    ...
    def test_lookup_terms_bad_host(self, mocked_request):
        ...
        self.assertEqual(
            "Check address input and try again. Allowed kind are: IPv4 Address",
            context.exception.assistance)
