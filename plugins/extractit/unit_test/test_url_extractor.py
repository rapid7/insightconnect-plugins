    ...
    def test_extract_urls_from_string(self):
        ...
        expected = {
            Output.URLS: [
                ...
                "http://example.com/auth/?=UserID&amp",
            ]
        }
    ...
    def test_extract_urls_from_string2(self):
        ...
        expected = {
            Output.URLS: [
                ...
                "http://example3.com/test1_test2_",
                "http://example4.com/test1_test2_",
                ...
                "http://foo1.com/blah_",
                "http://foo2.com/blah_",
                "http://foo3.com/unicode_",
                "http://foo4.com/",
                "http://code.test2.com/events/#&product=browser",
                "http://foo-2.bar/?q=Test",
                "http://1234.net",
                "http://a.b-c.de",
                "https://foo-bar.example.com/",
                "http://test.com/auth/?=UserID&amp",
            ]
        }
        self.assertEqual(actual, expected)
