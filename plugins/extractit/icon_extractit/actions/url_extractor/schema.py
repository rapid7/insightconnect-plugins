...
class UrlExtractorInput(insightconnect_plugin_runtime.Input):
  ...
  "properties": {
    ...
    "keep_original_urls": {
      ...
      "description": "Retain original URL encoding, if applicable e.g: If true: http://foo.bar/?q=Test%20URL-encoded%20stuff will be extracted as http://foo.bar/?q=Test%20URL-encoded%20stuff. If false, http://foo.bar/?q=Test%20URL-encoded%20stuff will be extracted as http://foo.bar/?q=Test as the %20 is decoded as a space",
      "default": false,
      "order": 3
    },
    "str": {
