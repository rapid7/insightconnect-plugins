class Regex:
    ...
    HumanToRegexPatterns = {
        "dd/mm/yyyy": r"([0][1-9]|[1|2][0-9]|[3][0|1])\/([0][1-9]|[1][0-2])\/([0-9]{4}|[0-9]{2})",
        "dd\\mm\\yyyy": r"([0][1-9]|[1|2][0-9]|[3][0|1])\\([0][1-9]|[1][0-2])\\([0-9]{4}|[0-9]{2})",
        "dd.mm.yyyy": r"([0][1-9]|[1|2][0-9]|[3][0|1]).([0][1-9]|[1][0-2]).([0-9]{4}|[0-9]{2})",
        "dd-mm-yyyy": r"([0][1-9]|[1|2][0-9]|[3][0|1])-([0][1-9]|[1][0-2])-([0-9]{4}|[0-9]{2})",

        "dd.mm.yy": r"([0]?[1-9]|[1|2][0-9]|[3][0|1]).([0]?[1-9]|[1][0-2]).([0-9]{4}|[0-9]{2})",
        "dd/mm/yy": r"([0]?[1-9]|[1|2][0-9]|[3][0|1])\/([0]?[1-9]|[1][0-2])\/([0-9]{4}|[0-9]{2})",
        "dd\\mm\\yy": r"([0]?[1-9]|[1|2][0-9]|[3][0|1])\\([0]?[1-9]|[1][0-2])\\([0-9]{4}|[0-9]{2})",
        "dd-mm-yy": r"([0]?[1-9]|[1|2][0-9]|[3][0|1])-([0]?[1-9]|[1][0-2])-([0-9]{4}|[0-9]{2})",

        "mm/dd/yyyy": r"([0][1-9]|[1][0-2])\/([0][1-9]|[1|2][0-9]|[3][0|1])\/([0-9]{4}|[0-9]{2})",
        "mm\\dd\\yyyy": r"([0][1-9]|[1][0-2])\\([0][1-9]|[1|2][0-9]|[3][0|1])\\([0-9]{4}|[0-9]{2})",
        "mm.dd.yyyy": r"([0][1-9]|[1][0-2]).([0][1-9]|[1|2][0-9]|[3][0|1]).([0-9]{4}|[0-9]{2})",
        "mm-dd-yyyy": r"([0][1-9]|[1][0-2])-([0][1-9]|[1|2][0-9]|[3][0|1])-([0-9]{4}|[0-9]{2})",

        "dd/mm/yy": r"([0][1-9]|[1|2][0-9]|[3][0|1])\/([0][1-9]|[1][0-2])\/([0-9]{2})",
        "dd\\mm\\yy": r"([0][1-9]|[1|2][0-9]|[3][0|1])\\([0][1-9]|[1][0-2])\\([[0-9]{2})",
        "dd.mm.yy": r"([0][1-9]|[1|2][0-9]|[3][0|1]).([0][1-9]|[1][0-2]).([0-9]{2})",
        "dd-mm-yy": r"([0][1-9]|[1|2][0-9]|[3][0|1])-([0][1-9]|[1][0-2])-([0-9]{2})",

        "mm/dd/yy": r"([0][1-9]|[1][0-2])\/([0][1-9]|[1|2][0-9]|[3][0|1])\/([0-9]{2})",
        "mm\\dd\\yy": r"([0][1-9]|[1][0-2])\\([0][1-9]|[1|2][0-9]|[3][0|1])\\([[0-9]{2})",
        "mm.dd.yy": r"([0][1-9]|[1][0-2]).([0][1-9]|[1|2][0-9]|[3][0|1]).([0-9]{2})",
        "mm-dd-yy": r"([0][1-9]|[1][0-2])-([0][1-9]|[1|2][0-9]|[3][0|1])-([0-9]{2})",

        "dd/mmm/yyyy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])\/(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\/([0-9]{4}|[0-9]{2})",
        "dd\\mmm\\yyyy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])\\(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\\([0-9]{4}|[0-9]{2})",
        "dd.mmm.yyyy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1]).(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec).([0-9]{4}|[0-9]{2})",
        "dd-mmm-yyyy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-([0-9]{4}|[0-9]{2})",

        "dd/mmm/yy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])\/(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\/([0-9]{2})",
        "dd\\mmm\\yy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])\\(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\\([0-9]{2})",
        "dd.mmm.yy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1]).(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec).([0-9]{2})",
        "dd-mmm-yy": r"((?i)[0]?[1-9]|[1|2][0-9]|[3][0|1])-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-([0-9]{2})",

        "yyyy/mm/dd": r"([0-9]{4})\/([0]?[1-9]|[1][0-2])\/([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yyyy\\mm\\dd": r"([0-9]{4})\\([0]?[1-9]|[1][0-2])\\([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yyyy.mm.dd": r"([0-9]{4}).([0]?[1-9]|[1][0-2]).([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yyyy-mm-dd": r"([0-9]{4}).([0]?[1-9]|[1][0-2]).([0]?[1-9]|[1|2][0-9]|[3][0|1])",

        "yyyy.mmm.dd": r"((?i)[0-9]{4}).(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec).([0]?[1-9]|[1][0-2])",
        "yyyy-mmm-dd": r"((?i)[0-9]{4})-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-([0]?[1-9]|[1][0-2])",
        "yyyy/mmm/dd": r"((?i)[0-9]{4})\/(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\/([0]?[1-9]|[1][0-2])",
        "yyyy\\mmm\\dd": r"((?i)[0-9]{4})\\(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\\([0]?[1-9]|[1][0-2])",

        "yy.mm.dd": r"([0-9]{2}).([0]?[1-9]|[1][0-2]).([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yy-mm-dd": r"([0-9]{2})-([0]?[1-9]|[1][0-2])-([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yy/mm/dd": r"([0-9]{2})\/([0]?[1-9]|[1][0-2])\/([0]?[1-9]|[1|2][0-9]|[3][0|1])",
        "yy\\mm\\dd": r"([0-9]{2})\\([0]?[1-9]|[1][0-2])\\([0]?[1-9]|[1|2][0-9]|[3][0|1])",

        "yyyy-mm-ddThh:mm": r"([0-9]{4})-([0][1-9]|[1][0-2])-([0][1-9]|[1|2][0-9]|[3][0|1])T([0-1][0-9]|[2][0-4]):([0-5][0-9])",
        "yyyy-mm-ddThh:mm:ss": r"([0-9]{4})-([0][1-9]|[1][0-2])-([0][1-9]|[1|2][0-9]|[3][0|1])T([0-1][0-9]|[2][0-4]):([0-5][0-9]|[6][0]):([0-5][0-9])",
    }
