...
from icon_zoom.triggers.user_activity_event import UserActivityEvent
import logging
import json
...
# Test class
class TestUserActivityEvent(TestCase):
    def test_user_activity_event_some_function_to_test(self):
        """
