...
from .schema import AndroidFileAnalysisInput, AndroidFileAnalysisOutput, Input, Output, Component
...
class AndroidFileAnalysis(insightconnect_plugin_runtime.Action):

    def __init__(self):
        super(self.__class__, self).__init__(
            name="android_file_analysis",
            description=Component.DESCRIPTION,
            input=AndroidFileAnalysisInput(),
            output=AndroidFileAnalysisOutput(),
        )
