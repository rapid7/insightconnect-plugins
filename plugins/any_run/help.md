...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Sid|integer|None|False|The signature ID used in detection|None|
|Tid|integer|None|False|The technique ID of the MITRE ATT&CK technique associated with the incident|None|
|V|integer|None|False|The version of the technique|None|
