...
class SentryConnection:
    ...
    def request(self, request_method, url, query_params=None, json=None, pagination_enabled=False):
        """
        ...
        if pagination_enabled:
            ...
            while True:
                response = self._call_api_url(request_method, api_url, query_params, json)
    ...
    def _call_api_url(self, request_method, api_url, query_params=None, json=None):
        self.logger.info("Request: Calling {} {}".format(request_method, api_url))
