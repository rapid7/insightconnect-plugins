...
class Component:
    DESCRIPTION = "Add a rule to a firewall security policy. This action works with a direct connection to the firewall"
...
class AddToPolicyInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class AddToPolicyOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
