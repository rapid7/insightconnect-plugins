...
class Component:
    DESCRIPTION = "Remove a rule from a firewall security policy. This action uses a direct connection to the firewall"
...
class RemoveFromPolicyInput(komand.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class RemoveFromPolicyOutput(komand.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
