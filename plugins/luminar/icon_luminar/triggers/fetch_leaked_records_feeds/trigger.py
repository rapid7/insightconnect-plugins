...
from .schema import (
    Component,
    FetchLeakedRecordsFeedsInput,
    FetchLeakedRecordsFeedsOutput,
    Input,
    Output,
)


class FetchLeakedRecordsFeeds(insightconnect_plugin_runtime.Trigger):
    _CACHE_FILE_NAME = "leaked_records"

    def __init__(self):
        super(self.__class__, self).__init__(
            name="fetch_leaked_records_feeds",
            description=Component.DESCRIPTION,
            input=FetchLeakedRecordsFeedsInput(),
            output=FetchLeakedRecordsFeedsOutput(),
        )
    ...
    def run(self, params={}):
        ...
        while True:
            try:
                ...
                records = pull_feeds(
                    self.connection.client, "leakedrecords", from_date, self.logger
                )
