...
class TestGetFullReport(TestCase):
    ...
    def test_get_full_report(self, mock_request, test_name, input_params, expected):
    ...
    def test_get_full_report_raise_exception(self, mock_request, test_name, input_parameters, cause, assistance):
