...
class UpdateAssetGroupSearchCriteriaInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
...
class UpdateAssetGroupSearchCriteriaOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
