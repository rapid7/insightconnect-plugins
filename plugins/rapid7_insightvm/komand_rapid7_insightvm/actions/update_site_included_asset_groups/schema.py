...
class UpdateSiteIncludedAssetGroupsInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
  ...
  "properties": {
    ...
    "overwrite": {
      "type": "boolean",
      "title": "Overwrite",
      "description": "Whether to overwrite the included asset group IDs to the current site or append to the previous list of asset group IDs",
      "default": true,
      "order": 3
    }
  },
...
class UpdateSiteIncludedAssetGroupsOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
