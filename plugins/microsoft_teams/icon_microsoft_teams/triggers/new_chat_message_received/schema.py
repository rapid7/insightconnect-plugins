...
class Component:
    DESCRIPTION = "Poll a chat for new messages"
...
class NewChatMessageReceivedInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
...
class NewChatMessageReceivedOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
  ...
  "properties": {
    "chat_id": {
      "type": "string",
      "title": "Chat ID",
      "description": "The ChatID where the message was posted",
      "order": 3
    },
    "indicators": {
