...
|First Word|string|None|True|Extracted first word from message (easy way to obtain a chat command)|None|
...
|Words|[]string|None|True|The message split by spaces into a list of words. This list makes finding and using parameters in chat commands easier|None|
...
|Body|itemBody|None|True|Representation of the content of the chat message|None|
...
|Etag|string|None|True|Version number of the chat message|None|
...
|ID|string|None|True|Unique ID of the message|None|
|Importance|string|None|True|The importance of the chat message|None|
|Last Edited Date Time|string|None|True|Timestamp when edits to the chat message were made|None|
|Last Modified Date Time|string|None|True|Timestamp when the chat message is created (initial setting) or modified|None|
...
* 4.3.0 - New actions: Get Message in Chat, Get Message in Channel | Update to latest SDK version
