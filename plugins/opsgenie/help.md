...
|----|----|-------|--------|-----------|----|-------|
|apikey|credential_secret_key|None|True|OpsGenie authorization API Key|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|identifier|string|None|True|Identifier of the alert|None|None|
|identifierType|string|id|False|Type of the identifier that is provided as an in-line parameter. Possible values are id, tiny and alias. Default value is id|['id', 'tiny', 'alias']|None|
|note|string|None|False|Additional alert note to add|None|None|
|source|string|None|False|Display name of the request source|None|None|
...
|alias|string|None|False|Client-defined identifier of the alert, that is also the key element of Alert De-Duplication|None|None|
|description|string|None|False|Description field of the alert that is generally used to provide a detailed information about the alert|None|None|
|details|object|None|False|Map of key-value pairs to use as custom properties of the alert|None|None|
|entity|string|None|False|Entity field of the alert that is generally used to specify which domain alert is related to|None|None|
|message|string|None|True|Message of the alert|None|None|
...
|Name|Type|Default|Required|Description|Enum|Example|
|----|----|-------|--------|-----------|----|-------|
|date|date|None|False|Starting date of the timeline that will be provided in format as (yyyy-MM-dd'T'HH:mm:ssZ) (e.g. 2017-01-15T08:00:00+02:00). Default date is the moment of the time that request is received.|None|None|
|flat|boolean|None|False|When enabled, retrieves user names of all on call participants. Default value is false|None|None|
|scheduleIdentifier|string|None|True|Identifier of the schedule|None|None|
|scheduleIdentifierType|string|id|False|Type of the schedule identifier that is provided as an in-line parameter. Possible values are id and name. Default value is id|['id', 'name']|None|
