...
def mock_conditions_actions_api_v1(url: str, status_code: int, params: dict = None) -> MockResponse:
...
def mock_conditions_actions_api_v2(method: str, url: str, status_code: int, params: dict = None) -> MockResponse:
