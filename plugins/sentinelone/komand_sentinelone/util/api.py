...
class SentineloneAPI:
    ...
    def agents_action_move_agent_to_new_site(self, filter: dict, data: dict) -> dict:
        return self._call_api(
            "POST", AGENTS_ACTION_ENDPOINT.format(action="move-to-site"), json={"filter": filter, "data": data}
        )
