...
class Component:
    DESCRIPTION = "Add a new request. Subject and requester parameters are obligatory, others are optional. In every parameter containing `ID` and `Name` fields please provide only one of them"
