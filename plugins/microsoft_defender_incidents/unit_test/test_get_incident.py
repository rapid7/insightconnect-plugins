...
from icon_microsoft_defender_incidents.actions.get_incident import GetIncident
from icon_microsoft_defender_incidents.actions.get_incident.schema import Input
...
class TestListIncidents(TestCase):
    ...
    def test_get_incident_exception(self, mock_request, exception, mock_backoff_function):
