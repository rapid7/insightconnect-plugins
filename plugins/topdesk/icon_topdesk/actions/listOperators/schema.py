...
class Component:
    DESCRIPTION = "Get a list of operators"
...
class ListOperatorsInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    ...
    "pageSize": {
      "type": "integer",
      "title": "Page Size",
      "description": "The amount of operators to be returned per page. Must be between 1 and 100",
      "order": 2
    },
    "query": {
      "type": "string",
    ...
    "start": {
      "type": "integer",
      "title": "Start",
      "description": "The offset at which to start listing the operators at. Must be greater or equal to 0",
      "order": 1
    }
  }
}
...
class ListOperatorsOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    "operators": {
      "type": "array",
      "title": "Operators",
      "description": "List of the operators",
      "items": {
