...
class Component:
    DESCRIPTION = "Monitor alert events"
...
class MonitorAlertEventsInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {}
    """)
...
class MonitorAlertEventsState(insightconnect_plugin_runtime.State):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    "last_event_time": {
      ...
      "description": "The datetime of the last retrieved alert event",
      "order": 1
    }
  }
}
...
class MonitorAlertEventsOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
