...
# from icon_palo_alto_cortex_xdr.actions.allow_file import AllowFile
# import json
# import logging
#
#
# class TestAllowFile(TestCase):
#     def test_integration_allow_file(self):
#         """
...
#         test_action = AllowFile()
#
#         test_conn.logger = log
#         test_action.logger = log
#
#         try:
#             with open("../tests/allow_file.json") as file:
