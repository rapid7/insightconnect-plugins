...
class UpdateSecurityGroupRuleDescriptionsIngressInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
...
class UpdateSecurityGroupRuleDescriptionsIngressOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
