...
class RevokeSecurityGroupIngressInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
  ...
  "properties": {
    ...
    "source_security_group_owner_id": {
      ...
      "description": "[EC2-Classic] The AWS account ID of the source security group, if the source security group is in a different account",
      "order": 8
    },
    "to_port": {
      "type": "integer",
...
class RevokeSecurityGroupIngressOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
