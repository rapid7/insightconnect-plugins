...
class UpdateSecurityGroupRuleDescriptionsEgressInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
...
class UpdateSecurityGroupRuleDescriptionsEgressOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
