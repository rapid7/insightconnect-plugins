...
class TestDeleteSavedSearch(TestCase):
    ...
    def test_delete_saved_search_ok(self) -> None:
    ...
    @patch("icon_microsoft_log_analytics.util.api.AzureLogAnalyticsClientAPI.get_saved_search")
    def test_delete_saved_search_exception(
        self, mock_request: MagicMock, exception: str, mock_backoff_function: MagicMock, mock_get: MagicMock
    ) -> None:
