...
from icon_azure_compute.actions.generalized_vm import GeneralizedVm
from icon_azure_compute.actions.generalized_vm.schema import Input, Output
...
class TestGeneralizedVm(TestCase):
    ...
    def test_generalized_vm_exception(
