    ...
    def run(self, params={}):
        ...
        if not nr:
            raise PluginException(
                cause="An invalid start time was provided.",
                assistance="For more information, see: https://docs.umbrella.com/investigate-api/docs/pattern-search-1#section-parameters-for-input",
            )
