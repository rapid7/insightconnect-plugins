...
from icon_azure_sentinel.actions import ListComments
...
class TestListEntities(TestCase):
    ...
    def test_list_entities_ok(self) -> None:
        self.action.run(self.params)
        self.action.connection.api_client.list_comments.assert_called_once_with(
