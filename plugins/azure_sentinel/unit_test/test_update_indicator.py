...
from icon_azure_sentinel.actions.update_indicator import UpdateIndicator
from icon_azure_sentinel.util.api import AzureSentinelClient

sys.path.append(os.path.abspath("../"))


class TestUpdateIndicator(TestCase):
    def setUp(self) -> None:
        self.action = UpdateIndicator()
    ...
    def test_update_indicator(self):
        ...
        self.action.connection.api_client.update_indicator.assert_called_once_with(
            "integrationLab",
            "sentinel",
            "abcde",
