...
class Component:
    DESCRIPTION = (
        "Get information from an alert by RRN. The RRN determines which alert the information is retrieved from"
    )
...
class GetAlertInformationInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(
        r"""
   {
  "type": "object",
...
class GetAlertInformationOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(
        r"""
   {
  "type": "object",
