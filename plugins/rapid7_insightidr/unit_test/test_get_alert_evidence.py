...
class TestGetAlertEvidences(TestCase):
    ...
    def test_get_alert_evidence_minimum(self, mock_request, alert_rrn, expected):
    ...
    def test_get_alert_evidence(self, mock_request, alert_rrn, size, index, expected):
    ...
    def test_get_alert_evidence_bad(self, mock_request, alert_rrn, cause, assistance):
        test_input = {Input.ALERT_RRN: alert_rrn}
        validate(test_input, GetAlertEvidenceInput.schema)
