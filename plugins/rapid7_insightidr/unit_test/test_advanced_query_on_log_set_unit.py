...
class TestAdvancedQueryOnLogSet(TestCase):
    ...
    def test_advanced_query_on_log_set_one_label(self, mock_post):
    ...
    def test_advanced_query_on_log_set_two_label(self, mock_post):
        actual = self.action.run(
            {
                Input.QUERY: "",
    ...
    def test_advanced_query_on_log_set_without_label(self, mock_post):
        actual = self.action.run(
            {
                Input.QUERY: "",
    ...
    def test_advanced_query_on_log_set_wrong_label(self, mock_post):
        actual = self.action.run(
            {
                Input.QUERY: "",
