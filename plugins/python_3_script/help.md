...
|timeout|integer|30|True|Timeout (in minutes) for function execution|None|30|None|None|
...
* 5.1.2 - `timeout` field made required for `run` action | Updated SDK to the latest version (6.3.3)
