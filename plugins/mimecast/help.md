...
* 5.3.10 - Task `monitor_siem_logs`: To move token to next file even if there is no files found | Task `monitor_siem_logs` increase the cuttoff time to 7 days during subsequent runs | bump SDK to 5.4.7
