...
* 3.1.1 - Action: Fixed - Upload Vulnerability Sync File now reports the response code and body returned by Automox instead of a generic server error | Updated SDK to the latest version (6.6.0)
