...
from komand_confluence.actions.get_page_content_by_id.schema import GetPageContentByIdInput, GetPageContentByIdOutput, Input
...
class TestGetPageContentById(TestCase):
    ...
    @parameterized.expand(
        [
            ("100001", "get_page_content"),
            ("100003", "get_page_content_not_found")
        ]
    )
