...
class TestGetAsset(TestCase):
    ...
    def test_get_asset_include_vulns_false(self, _mock_req):
        ...
        expected = Utils.read_file_to_dict("unit_test/expected_responses/get_asset.json.resp")
    ...
    def test_get_asset_include_vulns_true(self, _mock_req):
        ...
        expected = Utils.read_file_to_dict("unit_test/expected_responses/get_asset_include_vulns.json.resp")
        self.assertEqual(expected, actual)
