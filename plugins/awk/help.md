...
* 1.2.3 - Updated SDK to the latest version (6.5.1)
* 1.2.2 - Resolved an input validation issue in the process_string action that could allow OS command injection via the text and expression parameters (CVE-2026-8592) | Refreshed the plugin | Updated SDK to the latest version (6.4.3)
