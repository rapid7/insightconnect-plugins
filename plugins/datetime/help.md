...
|Name|Type|Default|Required|Description|Enum|Example|Placeholder|Tooltip|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|base_timestamp|date|None|False|Timestamp used for calculating a new delta timestamp eg. 2020-07-02T21:20:33+00:00, to use current time leave base timestamp parameter empty|None|2020-07-02T21:20:33+00:00|None|None|
...
```
{
  "base_timestamp": "2020-07-02T21:20:33+00:00",
  "time_amount": 20,
  "time_unit": "Days",
  "time_zone": "UTC"
}
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|timestamp|date|True|New timestamp|2020-07-02T21:20:33+00:00|
  
Example output:

```
{
  "timestamp": "2020-07-02T21:20:33+00:00"
}
```
...
* 3.0.7 - Updated SDK to the latest version (6.5.1)
* 3.0.6 - Updated dependencies | Updated SDK to the latest version (6.4.3)
