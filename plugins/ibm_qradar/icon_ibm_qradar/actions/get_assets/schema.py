...
class GetAssetsInput(insightconnect_plugin_runtime.Input):
  ...
  "properties": {
    "fields": {
      "type": "string",
      "title": "Fields",
      "description": "Specify the list of fields to be returned in the response. Specify the subfields in brackets (). Multiple fields in the same object must be comma separated. Sample fields to filter are  id, domain_id, hostnames(id), interfaces, products etc. More information about the fields can be found in plugin documentation",
      "order": 3
    },
    "filter": {
      "type": "string",
      "title": "Filter",
      "description": "Restrict the elements in a list based on the contents of various fields. E.g  id = 1001 and vulnerability_count \\u003e= 0",
      "order": 2
    },
    "range": {
      "type": "string",
