...
EMPTY_FILED_LIST_FOUND = "Empty Filed List Provided."
...
CLOSING_REASON_ID_NOT_PROVIDED = "Closing reason id is not provided to close the offense."
CLOSING_REASON_ID_PROVIDED_FOR_OTHER_STATUS = "Closing reason id is provided to open or hide the offense."
