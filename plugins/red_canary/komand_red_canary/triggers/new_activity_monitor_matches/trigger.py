import komand
import time
from .schema import NewActivityMonitorMatchesInput, NewActivityMonitorMatchesOutput
...
class NewActivityMonitorMatches(komand.Trigger):
    ...
    def __init__(self):
        super(self.__class__, self).__init__(
            ...
            description="Checks for new matches for a " "specific activity monitor",
    ...
    def run(self, params={}):
        ...
        while True:
            try:
                matches = self.connection.api.list_activity_monitor_matches(activity_monitor_id)
