...
from icon_jamf.actions.lock_computer import LockComputer
from icon_jamf.actions.lock_computer.schema import Input, Output
...
class TestLockComputer(TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.action = Util.default_action_connector(STUB_CONNECTION, LockComputer())

    @mock.patch("requests.request", side_effect=mock_request_201)
    def test_lock_computer_ok(self, mocked_post) -> None:
    ...
    def test_lock_computer_exception(self, mock_request, exception) -> None:
