...
from icon_intsights.actions.add_manual_alert import AddManualAlert
from icon_intsights.actions.add_manual_alert.schema import Input
...
class TestAddManualAlert(TestCase):
    ...
    def test_add_manual_alert_should_success(self, make_request):
        ...
        expected = {
            'alert_id': '7cafac7ec5adaebf62257a4c'
        }
