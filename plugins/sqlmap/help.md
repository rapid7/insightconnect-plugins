...
[SQLMap](http://sqlmap.org/) is an open-source penetration testing tool that automates detecting and exploiting SQL injection flaws and taking over database servers. It features a powerful detection engine, supports database fingerprinting, data extraction, filesystem access, and OS command execution via out-of-band connections. The SQLMap plugin enables target scanning and result analysis
...
* 2.0.2 - Updated SDK to the latest version (6.6.0)
