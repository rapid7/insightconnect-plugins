...
| :--- | :--- | :--- | :--- | :--- |
|success|boolean|True|Whether or not the action was successful|True|
...
This action is used to blacklist an IP, URL, file SHA1 or domain in the UDSO list
...
This action is used to deletes existing OpenIOC files from the Apex Central server
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|Data|[]delete_data|False|Contains the data returned by the specific API|[{"DeletedStatus": 1, "FileHashID": "769fcc7550bf98d96bccb7e22a5557301c403455"}]|
|FeatureCtrl|FeatureCtrl|False|The Apex Central deployment model|{'mode': '0'}|
|Meta|Meta|False|Indicates the response status, including the result, error code, and error message|{'ErrorCode': 0, 'Result': 1}|
|PermissionCtrl|PermissionCtrl|False|Indicates the permissions assigned to the logged-on user account for accessing Apex Central menu items and features|{'permission': '255'}|
|SystemCtrl|SystemCtrl|False|Indicates the suspicious object distribution role of the Apex Central server|{'TmcmSoDist_Role': 'none'}|
...
This action is used to downloads existing RCA files from the Apex Central server
...
This action is used to retrieves a list of all Security Agents with the Endpoint Sensor feature enabled

##### Input

|Name|Type|Default|Required|Description|Enum|Example|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|agent_guid|string|None|True|GUID of the agent|None|626dcf14-b0c3-4b00-bc76-71cf5713ab2e|
  
Example input:

```
{
  "agent_guid": "626dcf14-b0c3-4b00-bc76-71cf5713ab2e"
}
```
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|agentEntity|agentEntity|False|Agent entity data|{'agentGuid': '626dcf14-b0c3-4b00-bc76-71cf5713ab2e', 'ip': '198.51.100.100', 'isEnable': True, 'isImportant': False, 'isOnline': False, 'isolateStatus': 1, 'machineGuid': '3E4EC062-A620-4DE6-9DA9-395DD98EC1D8', 'machineName': 'TREND-MICRO-TES', 'machineOS': 'Windows 10', 'machineType': 'Desktop', 'productType': 15, 'serverGuid': 'C22E1795-BF95-45BB-BC82-486B0F5161BE', 'userGuid': '6AC1B3DCF-CE52-8279-EE9E-E101FD504E3', 'userName': 'TREND-MICRO-TES\\vagrant'}|
|agentQueryStatus|agentQueryStatus|False|Agent query status data|{'hasFullAgents': True, 'hasFullRbac': True}|
...
This action is used to retrieves results of investigations in different formats based on the specified taskId
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|Data|api_data|True|Contains the data returned by the specific API|{'Code': 0, 'CodeType': 1, 'Message': 'OK', 'Data': {'taskId': 'B44BE9AE-80A9-4048-A4CE-064D90CB6D4C', 'lastContentId': '[\r\n  {\r\n    "serverGuid": "C22E1795-BF95-45BB-BC82-486B0F5161BE",\r\n    "lastContentId": 48,\r\n    "hasMore": false,\r\n    "totalProgress": 0,\r\n    "currentProgress": 0\r\n  }\r\n]', 'hasMore': False, 'serverName': 'Apex One as a Service', 'serverGuid': 'C22E1795-BF95-45BB-BC82-486B0F5161BE', 'content': [{'statusCode': 0, 'message': 'TMSL_S_SUCCESS', 'content': {'agentServerMeta': [{'agentGuid': '626dcf14-b0c3-4b00-bc76-71cf5713ab2e', 'minFirstSeen': 1589061887, 'serverMeta': [{'criteriaNo': 0, 'sweepingType': 7, 'metaValue': 'notepad.exe', 'metaHashId': '-1666102285318829169', 'firstSeen': 1589061887, 'lastSeen': 1589131161}], 'isCriteriaExceedMaxMetaCount': [False], 'serverGuid': 'C22E1795-BF95-45BB-BC82-486B0F5161BE', 'serverName': 'Apex One as a Service', 'serverMode': 1, 'isOnline': True, 'isEnable': True, 'isImportant': False, 'ip': '198.51.100.100', 'machineGuid': '3E4EC062-A620-4DE6-9DA9-395DD98EC1D8', 'machineName': 'TREND-MICRO-TES', 'machineType': 'Desktop', 'userName': 'TREND-MICRO-TES\\vagrant', 'userGuid': '6AC1B3DCF-CE52-8279-EE9E-E101FD504E3', 'isolateStatus': 4, 'machineOS': 'Windows 10', 'productType': 15}]}}]}, 'TimeZone': -4}|
|FeatureCtrl|FeatureCtrl|False|The Apex Central deployment model|{'mode': '0'}|
|Meta|Meta|False|Indicates the response status, including the result, error code, and error message|{'result': 1, 'errorCode': 0, 'errorMessgae': 'Success'}|
|PermissionCtrl|PermissionCtrl|False|Indicates the permissions assigned to the logged-on user account for accessing Apex Central menu items and features|{'permission': '255'}|
|SystemCtrl|SystemCtrl|False|Indicates the suspicious object distribution role of the Apex Central server|{'TmcmSoDist_Role': 'none'}|
...
This action is used to retrieves a list of OpenIOC files from the Apex Central server
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|data|IOC_Data|False|Contains the data returned by the specific API|{'FilingCabinet': [{'FileHashID': 'cd9b739b7c6e488080412e9a831e9260a468564f', 'FileName': 'file.txt', 'FileAddedDatetime': '05/10/2020 15:58:41', 'UploadedFrom': 1, 'UploadedBy': 'Integration Lab', 'ExtractingStatus': 999, 'ShortDesc': 'Cryptolocker Detection (EXPERIMENTAL)'}, {'FileHashID': '2a99370fd6218b6b8e0c3413f11eb504a4a60225', 'FileName': 'openioc1', 'FileAddedDatetime': '05/10/2020 12:28:18', 'UploadedFrom': 1, 'UploadedBy': 'Integration Lab', 'ExtractingStatus': 1, 'ShortDesc': 'SHELLDC.DLL (BACKDOOR)'}, {'FileHashID': 'fc3f17bd9068c2588c4c475d2d08a0e7f04f434d', 'FileName': 'cryptolocker2.ioc', 'FileAddedDatetime': '05/10/2020 10:39:17', 'UploadedFrom': 1, 'UploadedBy': 'Integration Lab', 'ExtractingStatus': 1, 'ShortDesc': 'Cryptolocker Detection (EXPERIMENTAL)'}], 'TotalIOCCount': 3}|
|feature_ctrl|FeatureCtrl|False|The Apex Central deployment model|{'mode': '0'}|
|meta|Meta|False|Indicates the response status, including the result, error code, and error message|{'Result': 1, 'ErrorCode': 0}|
|permission_ctrl|PermissionCtrl|False|Indicates the permissions assigned to the logged-on user account for accessing Apex Central menu items and features|{'permission': '255'}|
|system_ctrl|SystemCtrl|False|Indicates the suspicious object distribution role of the Apex Central server|{'TmcmSoDist_Role': 'none'}|
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|result_code|integer|False|The Apex Central Automation API result code|1|
|result_content|[]result_content|False|The Apex Central Automation API result content|[{"entity_id": "626dcf14-b0c3-4b00-bc76-71cf5713ab2e", "product": "SLF_PRODUCT_OFFICESCAN_CE", "managing_server_id": "C22E1795-BF95-45BB-BC82-486B0F5161BE", "folder_path": "Workgroup", "ip_address_list": "198.51.100.100", "mac_address_list": "08-00-27-96-86-8E", "host_name": "TREND-MICRO-TES", "isolation_status": "normal", "capabilities": ["cmd_restore_isolated_agent", "cmd_isolate_agent", "cmd_relocate_agent", "cmd_uninstall_agent"]}]|
|result_description|string|False|The Apex Central Automation API result description|Operation successful|
...
This action is used to retrieves a list of Security Agents
...
|Name|Type|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- |
|search_agent_response|[]search_agent_response|False|Search agent response|[{"capabilities": ["cmd_restore_isolated_agent", "cmd_isolate_agent", "cmd_relocate_agent", "cmd_uninstall_agent"], "entity_id": "626dcf14-b0c3-4b00-bc76-71cf5713ab2e", "folder_path": "Workgroup", "host_name": "TREND-MICRO-TES", "ip_address_list": "198.51.100.100", "isolation_status": "normal", "mac_address_list": "08-00-27-96-86-8E", "managing_server_id": "C22E1795-BF95-45BB-BC82-486B0F5161BE", "product": "SLF_PRODUCT_OFFICESCAN_CE"}]|
...
This action is used to uploads OpenIOC files to the Apex Central server
...
|PermissionCtrl|PermissionCtrl|False|Indicates the permissions assigned to the logged-on user account for accessing Apex Central menu items and features|{'permission': '255'}|
|SystemCtrl|SystemCtrl|False|Indicates the suspicious object distribution role of the Apex Central server|{'TmcmSoDist_Role': 'none'}|
|uploaded_info_list|[]uploaded_info_list|False|Uploaded Result Info List|[{"FileHashID": "cd9b739b7c6e488080412e9a831e9260a468564f", "FileName": "file.txt", "UploadedStatus": 1}]|
|uploaded_message_list|[]uploaded_message_list|False|Uploaded Result Message List|[{"Message": "Uploaded 1 OpenIOC file(s) successfully.", "MessageType": 1}]|
...
| :--- | :--- | :--- | :--- | :--- | :--- |
|Type|integer|None|False|Type|1|
|Value|string|None|False|Value of the filter type|a|
  
**termination_info**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Name|integer|None|False|Metadata type of object to terminate|101|
|Value|string|None|False|Hash value of the object to terminate|4608E210A73961CE2967343EA7A55CF9918B053F|
  
**meta_page**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Limit|integer|50|False|Number of records to retrieve|50|
|Offset|integer|0|False|Page where to start retrieving records|0|
  
**agentEntity**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Agent GUID|string|None|False|Agent GUID|None|
|IP|string|None|False|IP|None|
|Is Important|boolean|None|False|Is important|None|
|Is Online|boolean|None|False|Is online|None|
|ISO Late Status|integer|None|False|ISO late status|None|
|Machine GUID|string|None|False|Machine GUID|None|
|Machine Name|string|None|False|Machine name|None|
|Machine OS|string|None|False|Machine os|None|
|Machine Type|string|None|False|Machine type|None|
|Server GUID|string|None|False|Server GUID|None|
  
**agentQueryStatus**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Has Full Agents|boolean|None|False|Has full agents|None|
|Has Full RBAC|boolean|None|False|Has full RBAC|None|
  
**pagination**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Limit|integer|None|False|Limit|None|
|Offset|integer|None|False|Offset|None|
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Agent Entity|[]agentEntity|None|False|Agent entity|None|
|Agent Query Status|agentQueryStatus|None|False|Agent query status|None|
|CSV|string|None|None|Contents of the CSV file|None|
|Pagination|pagination|None|False|Pagination|None|
  
**termination_content**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Agent GUID|[]string|None|False|GUID of the terminated agents|None|
|Message|string|None|False|The error message of the response from Endpoint Sensor server|None|
|Process Termination Summary GUID|string|None|False|The GUID of the process termination summary|None|
|Status|integer|None|False|The status of the agent|None|
|Status Code|integer|None|False|The status code of the response from Endpoint Sensor server|None|
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Content|termination_content|None|False|Contains the content returned from Endpoint Sensor server|None|
|Message|string|None|False|The error message of the response from Endpoint Sensor server|None|
|Status Code|integer|None|False|The status code of the response from Endpoint Sensor server|None|
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Content|[]contents|None|False|Contents|None|
|Has More|boolean|None|False|Has more|None|
|Last Content ID|string|None|False|Last content ID|None|
|Server GUID|string|None|False|Server GUID|None|
|Server Name|string|None|False|Server name|None|
|Task ID|string|None|False|Task id|None|
  
**termination_data**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Content|[]termination_contents|None|False|Contents|None|
|Has More|boolean|None|False|Indicates whether the source has more results|None|
|Last Content ID|string|None|False|ID used to retrieve the next set of results|None|
|Server GUID|string|None|False|Trend Micro UID of the server|None|
|Server Name|string|None|False|Name of the server|None|
|Task ID|string|None|False|Task ID received from the request|None|
  
**api_data**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Code|integer|None|False|CMEF code related to CodeType|None|
|Code Type|integer|None|False|Indicate Code is iES/CMEF error code, Apex Central error code or HTTP Code|None|
|Data|Data|None|False|Contains the data returned from Endpoint Sensor server|None|
|Message|string|None|False|CMEF message|None|
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Code|integer|None|False|CMEF result codes|0|
|Code Type|integer|None|False|Indicate Code is iES/CMEF error code, Apex Central error code or HTTP Code|None|
|Data|termination_data|None|False|Contains the data returned from endpoint server|None|
|Message|string|None|False|CMEF message|None|
|Time Zone|integer|None|False|Time zone|None|
...
|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Error Code|integer|None|False|The error code of the response|None|
|Error Message|string|None|False|The error message of the response|None|
|Result|integer|None|False|The result code of the response|None|
  
**PermissionCtrl**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Elements|string|None|False|The value is always null for Custom Intelligence Automation APIs|None|
|Permission|string|None|False|Permission|None|
  
**SystemCtrl**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Tmcm So Dist Role|string|None|False|Tmcm so dist role|None|
  
**FilingCabinet**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Extracting Status|integer|None|False|The suspicious object extraction status of the uploaded file|None|
|File Added Datetime|string|None|False|The date and time for when the file was uploaded|None|
|File Hash ID|string|None|False|The file hash ID of the uploaded file|None|
|File Name|string|None|False|The file name of the uploaded file|None|
|Short Desc|string|None|False|Short description|None|
|Title|string|None|False|The short description of the uploaded file|None|
|Uploaded|string|None|False|The name of the user account that uploaded the file|None|
|Uploaded From|integer|None|False|The Source of the uploaded file|None|
  
**IOC_Data**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Filing Cabinet|[]FilingCabinet|None|False|OpenIOC filing cabinet list|None|
|Total IOC Count|integer|None|False|The total number of objects extracted from the uploaded file|None|
  
**api_response**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Data|api_data|None|False|Contains the data returned by the specific API|None|
|Feature CTRL|FeatureCtrl|None|False|The Apex Central deployment model|None|
|Meta|Meta|None|False|Indicates the response status, including the result, error code, and error message|None|
|Permission CTRL|PermissionCtrl|None|False|Indicates the permissions assigned to the logged-on user account for accessing Apex Central menu items and features|None|
|System CTRL|SystemCtrl|None|False|Indicates the suspicious object distribution role of the Apex Central server|None|
  
**delete_data**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Deleted Status|integer|None|False|Indicates the deletion status of the specified file|None|
|File Hash ID|string|None|False|Indicates the file hash ID of the deleted file|None|
  
**uploaded_info_list**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|File Hash ID|string|None|None|The file hash ID of the uploaded file|None|
|File Name|string|None|None|The file name of the uploaded file|None|
|Uploaded Status|integer|None|None|The result code indicating the file upload status|None|
  
**uploaded_message_list**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Message|string|None|None|The status message content|None|
|File Name|integer|None|None|The type of status message|None|
  
**result_content**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|Capabilities|[]string|None|None|Result capabilities|None|
|Entity ID|string|None|None|Result entity ID|None|
|Folder Path|string|None|None|Result folder path|None|
|Host Name|string|None|None|Result host name|None|
|IP Address List|string|None|None|Result IP address list|None|
|Isolation Status|string|None|None|Result isolation status|None|
|MAC Address List|string|None|None|Result MAC address list|None|
|Managing Server ID|string|None|None|Result managing server ID|None|
|Product|string|None|None|Result product|None|
  
**search_agent_response**

|Name|Type|Default|Required|Description|Example|
| :--- | :--- | :--- | :--- | :--- | :--- |
|AD Domain|string|None|None|Security agent AD domain|None|
|Capabilities|[]string|None|None|Security agent capabilities|None|
|Entity ID|string|None|None|Security agent entity ID|None|
|Folder Path|string|None|None|Security agent folder path|None|
|Host Name|string|None|None|Security agent host name|None|
|IP Address List|string|None|None|Security agent IP address list|None|
|Isolation Status|string|None|None|Security agent isolation status|None|
|MAC Address List|string|None|None|Security agent MAC Address List|None|
|Managing Server ID|string|None|None|Security agent managing server ID|None|
|Product|string|None|None|Security agent product|None|
