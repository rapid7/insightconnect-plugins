...
class Input:
    ...
    HOST_IP = "host_ip"
    HOST_NAME = "host_name"
    SCAN_SUMMARY_GUID = "scan_summary_guid"
...
class DownloadRcaCsvFileInput(insightconnect_plugin_runtime.Input):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
...
class DownloadRcaCsvFileOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads(r"""
   {
  "type": "object",
  "title": "Variables",
