...
from carbon_black_response.icon_carbon_black_response.actions.list_binaries.schema import Input
from carbon_black_response.icon_carbon_black_response.actions.list_binaries import ListBinaries
...
class TestListProcesses(TestCase):
    def setUp(self):
        ...
        self.params_data = {
            Input.QUERY: "domain:www.carbonblack.com",
            Input.ROWS: 10,
            Input.START: 0
        }
    ...
    def test_list_binaries_success(self, mock_connection):
        ...
        self.mock_client.get_object.return_value = {"results": {"binaries": [{"host_count": 1}]}, "meta_data": {"page": 1}}
