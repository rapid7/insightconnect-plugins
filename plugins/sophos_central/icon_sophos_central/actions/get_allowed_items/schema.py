...
class Component:
    DESCRIPTION = "Get a list of allowed items"
...
class GetAllowedItemsInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class GetAllowedItemsOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
