...
class GetEndpointGroupInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
...
class GetEndpointGroupOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    "endpointGroup": {
      ...
      "description": "Information about the provided endpoint group",
      "order": 1
    }
  },
  "definitions": {
