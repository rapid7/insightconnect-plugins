...
class GetDeliveredThreatsInput(insightconnect_plugin_runtime.Input):
  ...
  "properties": {
    "subject": {
      "type": "string",
      "title": "Subject",
      "description": "The subject of the email for which the results will be returned. Returns all results if left empty",
      "order": 3
    },
    "threat_status": {
      "type": "string",
...
class GetDeliveredThreatsOutput(insightconnect_plugin_runtime.Output):
  ...
  "properties": {
    "results": {
      "$ref": "#/definitions/delivered_threats",
      "title": "Results",
