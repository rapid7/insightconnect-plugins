...
* 3.0.0 - Add `all` value to `threat_type` and `threat_status` enum inputs in Get Blocked Clicks, Get Permitted Clicks, Get Blocked Messages, Get Delivered Threats, Get All Threats actions
