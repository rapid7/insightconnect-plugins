...
* 3.0.0 - Added Relative Time options to Advanced Query actions | Fix to clean up error messages | Fix issue where a query with no results would crash the plugin
