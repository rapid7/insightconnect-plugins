...
func (i *GetPartitionsInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *GetPartitionsOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *GetPartitionsAction) Run(conn *connection.Connection, input *GetPartitionsInput, log plog.Logger) (*GetPartitionsOutput, error) {
	ps, err := conn.Client.Partitions(input.Topic)
	if err != nil {
...
func (a *GetPartitionsAction) Test(conn *connection.Connection, input *GetPartitionsInput, log plog.Logger) (*GetPartitionsOutput, error) {
