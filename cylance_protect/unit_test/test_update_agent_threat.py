...
from icon_cylance_protect.actions.update_agent_threat import UpdateAgentThreat
import json
import logging


class TestUpdateAgentThreat(TestCase):
    def test_integration_update_agent_threat(self):
        """
        ...
        test_action = UpdateAgentThreat()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/update_agent_threat.json") as file:
