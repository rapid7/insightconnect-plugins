...
from icon_cylance_protect.actions.search_threat_agents import SearchThreatAgents
import json
import logging


class TestSearchThreatAgents(TestCase):
    def test_integration_search_threat_agents(self):
        """
        ...
        test_action = SearchThreatAgents()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/search_threat_agents.json") as file:
    ...
    def test_search_threat_agents(self):
        """
