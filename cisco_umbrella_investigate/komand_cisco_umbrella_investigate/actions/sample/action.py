    ...
    def test(self):
        return {
            ...
            "behaviors": [
                ...
                {
                    "tags": ["network", "http", "nginx"],
                    "severity": 25,
                    "hits": 6,
                    "title": "Outbound Communications to Nginx Web Server",
                    "category": ["network"],
                    "threat": 6,
                    "name": "nginx-webserver-detected",
                    "confidence": 25,
                },
                {
                    ...
                    "severity": 90,
                    "hits": 124,
                    "title": "Process Deleted SafeBoot Registry Key",
                    "category": ["weakening"],
                    "threat": 81,
                    "name": "safeboot-registry-key-deleted",
                    "confidence": 90,
                },
                {
                    "tags": ["autorun", "file", "process"],
                    "severity": 100,
                    "hits": 1,
                    "title": "Process Enabled Autorun through the Creation of autorun.inf",
                    "category": ["persistence", "file"],
                    "threat": 100,
                    "name": "drive-autoplay-modification",
                    "confidence": 100,
                },
                {
                    "tags": ["process", "registry", "system"],
                    "severity": 90,
                    "hits": 1,
                    "title": "Process Deleted SafeBoot Registry Key Value",
                    "category": ["weakening"],
                    "threat": 81,
                    "name": "safeboot-registry-key-value-deleted",
                    "confidence": 90,
                },
                {
                ...
                {
                    "tags": ["registry", "process"],
                    "severity": 50,
                    "hits": 1,
                    "title": "Process Added a Service to the ControlSet Registry Key",
                    "category": ["persistence"],
                    "threat": 25,
                    "name": "currentcontrolset-service-added",
                    "confidence": 50,
                },
                {
                    "tags": ["suspicious", "threshold"],
                    "severity": 90,
                    "hits": 1,
                    "title": "Excessive Suspicious Activity Detected",
                    "category": ["compound"],
                    "threat": 90,
                ...
                {
                    "tags": ["trojan", "host", "process", "lock", "mutex", "RAT"],
                    "severity": 100,
                    "hits": 2,
                    "title": "Sality Default Mutex Detected",
                    "category": ["malware"],
                    "threat": 100,
                    "name": "malware-sality-mutex",
                    "confidence": 100,
                },
                {
                    "tags": ["executable", "file", "process", "PE"],
                ...
                {
                    "tags": ["dns", "sinkhole", "botnet", "localhost", "parking", "loopback"],
                    "severity": 25,
                    "hits": 1,
                    "title": "Domain Resolves to Localhost",
                    "category": ["network"],
                    "threat": 6,
                    "name": "localhost-ipaddress-detected",
                    "confidence": 25,
                },
                {
                    "tags": ["file", "attributes", "anomaly"],
                    "severity": 40,
                    "hits": 6,
                    "title": "PE Has Sections Marked Executable and Writable",
                    "category": ["attribute"],
                    "threat": 24,
                    "name": "pe-section-execute-writable",
                    "confidence": 60,
                },
                {
                    "tags": ["communications", "command and control"],
                    "severity": 25,
                    "hits": 9,
                    "title": "RAT Queried Domain",
                    "category": ["network"],
                    "threat": 6,
                    "name": "feed-domain-rat",
                    "confidence": 25,
                },
                {
                    ...
                    "severity": 75,
                    "hits": 9,
                    "title": "Outbound HTTP GET Request",
                    "category": ["network"],
                    "threat": 56,
                    "name": "network-communications-http-get",
                    "confidence": 75,
                },
                {
                    "tags": ["packer", "crypter", "encoding", "PE"],
                    "severity": 30,
                    "hits": 6,
                ...
                {
                    "tags": ["process", "registry"],
                    "severity": 60,
                    "hits": 8,
                    "title": "Process Disables Security Center Notifications",
                    "category": ["weakening"],
                    "threat": 54,
                    "name": "disables-security-center-notifications",
                    "confidence": 90,
                },
                {
                    "tags": ["communication"],
                    ...
                    "category": ["network"],
                    "threat": 18,
                    "name": "dns-query-nxdomain",
                    "confidence": 75,
                },
                {
                    "tags": ["network", "ttl", "dns", "fast flux", "command and control"],
                    "severity": 35,
                    "hits": 18,
