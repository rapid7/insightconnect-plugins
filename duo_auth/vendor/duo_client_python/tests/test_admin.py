...
class TestAdmin(unittest.TestCase):
    def setUp(self):
        ...
        self.client_list._connect = lambda: util.MockHTTPConnection(
            data_response_should_be_list=True
        )
        ...
        self.client_authlog._connect = lambda: util.MockHTTPConnection(
            data_response_from_get_authlog=True
        )
    ...
    def test_get_users_by_name(self):
        ...
        self.assertEqual(
            util.params_to_dict(args), {"username": ["foo"], "account_id": [self.client.account_id]}
        )
        self.assertEqual(response["body"], None)
        response = self.client.get_users_by_name("foo")
        (uri, args) = response["uri"].split("?")
    ...
    def test_modify_group(self):
        ...
        self.assertEqual(
            util.params_to_dict(response["body"]), {"account_id": [self.client.account_id]}
        )
