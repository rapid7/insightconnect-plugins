...
func (i *ToUnicodeInput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (o *ToUnicodeOutput) Validate(log plog.Logger) []error {
	errs := make([]error, 0)
...
func (a *ToUnicodeAction) Test(conn *connection.Connection, input *ToUnicodeInput, log plog.Logger) (*ToUnicodeOutput, error) {
