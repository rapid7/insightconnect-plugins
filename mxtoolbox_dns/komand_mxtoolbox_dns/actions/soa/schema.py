    ...
    "SOA_Output": {
      ...
      "properties": {
        ...
        "Information": {
          ...
          "title": "Information",
          "items": {
            "$ref": "#/definitions/SOA_Information"
          },
          "order": 3
        },
        "IsBruteForce": {
        ...
        "RelatedLookups": {
          ...
          "items": {
            "$ref": "#/definitions/SOA_RelatedLookups"
          },
          "order": 4
        },
        "ReportingNameServer": {
        ...
        "Transcript": {
          ...
          "title": "Transcript",
          "items": {
            "$ref": "#/definitions/SOA_Transcript"
          },
          "order": 12
        },
        "UID": {
