    ...
    "TXT_Output": {
      ...
      "properties": {
        ...
        "Information": {
          ...
          "title": "Information",
          "items": {
            "$ref": "#/definitions/TXT_Information"
          },
          "order": 3
        },
        "IsBruteForce": {
        ...
        "RelatedLookups": {
          ...
          "items": {
            "$ref": "#/definitions/TXT_RelatedLookups"
          },
          "order": 4
        },
        "ReportingNameServer": {
        ...
        "Transcript": {
          ...
          "title": "Transcript",
          "items": {
            "$ref": "#/definitions/TXT_Transcript"
          },
          "order": 12
        },
        "UID": {
