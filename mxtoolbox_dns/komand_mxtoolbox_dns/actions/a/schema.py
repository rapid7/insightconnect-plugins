    ...
    "A_Output": {
      ...
      "properties": {
        ...
        "RelatedLookups": {
          ...
          "items": {
            "$ref": "#/definitions/A_RelatedLookups"
          },
          "order": 4
        },
        "ReportingNameServer": {
