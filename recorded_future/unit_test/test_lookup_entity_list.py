...
class TestLookupEntityList(TestCase):
    def test_integration_lookup_entity_list(self):
        """
        ...
        test_action = LookupEntityList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/lookup_entity_list.json") as file:
    ...
    def test_lookup_entity_list(self):
        """
