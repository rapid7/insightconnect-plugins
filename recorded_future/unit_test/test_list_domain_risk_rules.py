...
class TestListDomainRiskRules(TestCase):
    def test_integration_list_domain_risk_rules(self):
        """
        ...
        test_action = ListDomainRiskRules()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/list_domain_risk_rules.json") as file:
    ...
    def test_list_domain_risk_rules(self):
        """
