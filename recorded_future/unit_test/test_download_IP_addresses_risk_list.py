...
class TestDownloadIPAddressesRiskList(TestCase):
    def test_integration_download_IP_addresses_risk_list(self):
        """
        ...
        test_action = DownloadIPAddressesRiskList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/download_IP_addresses_risk_list.json") as file:
    ...
    def test_download_IP_addresses_risk_list(self):
        """
