...
class TestDownloadHashRiskList(TestCase):
    def test_integration_download_hash_risk_list(self):
        """
        ...
        test_action = DownloadHashRiskList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/download_hash_risk_list.json") as file:
    ...
    def test_download_hash_risk_list(self):
        """
