...
class TestListIPAddressesRiskRules(TestCase):
    def test_integration_list_IP_addresses_risk_rules(self):
        """
        ...
        test_action = ListIPAddressesRiskRules()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/list_IP_addresses_risk_rules.json") as file:
    ...
    def test_list_IP_addresses_risk_rules(self):
        """
