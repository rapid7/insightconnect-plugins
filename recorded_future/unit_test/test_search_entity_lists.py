...
class TestSearchEntityLists(TestCase):
    def test_integration_search_entity_lists(self):
        """
        ...
        test_action = SearchEntityLists()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/search_entity_lists.json") as file:
    ...
    def test_search_entity_lists(self):
        """
