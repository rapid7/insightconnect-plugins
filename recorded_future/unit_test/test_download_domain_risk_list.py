...
class TestDownloadDomainRiskList(TestCase):
    def test_integration_download_domain_risk_list(self):
        """
        ...
        test_action = DownloadDomainRiskList()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/download_domain_risk_list.json") as file:
    ...
    def test_download_domain_risk_list(self):
        """
