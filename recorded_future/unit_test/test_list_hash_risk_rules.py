...
class TestListHashRiskRules(TestCase):
    def test_integration_list_hash_risk_rules(self):
        """
        ...
        test_action = ListHashRiskRules()

        test_conn.logger = log
        test_action.logger = log

        try:
            with open("../tests/list_hash_risk_rules.json") as file:
    ...
    def test_list_hash_risk_rules(self):
        """
